...
func TestMatchSlashCommands(t *testing.T) {
	tests := []struct {
		...
		{name: "empty prefix lists all", prefix: "", wantNames: []string{"help", "new", "end", "status", "context", "compact", "resume", "sessions", "permission", "export", "auth", "file", "open", "plan", "clear", "quit"}},
