...
func TestCommandRules_TokenParsing(t *testing.T) {
	tests := []struct {
		...
		{"notify delete [string]", "notify delete [name]", true},
		{"notify delete [string]", "notify delete mynotify", true},
		{"notify config", "notify config", true},
		{"notify list", "notify delete [name]", false},
		{"notify delete [string]", "notify list", false},
		{"notify config", "notify list", false},
		{"notify delete [string]", "notify delete", false},
	}
