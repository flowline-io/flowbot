...
func newTodo(db *gorm.DB, opts ...gen.DOOption) todo {
	...
	_todo.KeyResultID = field.NewInt64(tableName, "key_result_id")
	_todo.ParentID = field.NewInt64(tableName, "parent_id")
...
func (t *todo) updateTableName(table string) *todo {
	...
	t.KeyResultID = field.NewInt64(table, "key_result_id")
