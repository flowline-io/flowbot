...
func (_q *AgentSkillQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AgentSkillQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *AgentSkillQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AgentSkillQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *AgentSkillQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *AgentSkillQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AgentSkillQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(agentskill.Table, agentskill.Columns, sqlgraph.NewFieldSpec(agentskill.FieldID, field.TypeInt64))
	_spec.From = _q.sql
