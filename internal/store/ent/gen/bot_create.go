...
func (_c *BotCreate) SetState(v int) *BotCreate {
	_c.mutation.SetState(v)
	return _c
}

// SetNillableState sets the "state" field if the given value is not nil.
func (_c *BotCreate) SetNillableState(v *int) *BotCreate {
	if v != nil {
		_c.SetState(*v)
	}
	return _c
...
func (_c *BotCreate) SetID(v int64) *BotCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *BotCreate) check() error {
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`gen: missing required field "Bot.name"`)}
	}
	...
	if _, ok := _c.mutation.State(); !ok {
		return &ValidationError{Name: "state", err: errors.New(`gen: missing required field "Bot.state"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`gen: missing required field "Bot.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`gen: missing required field "Bot.updated_at"`)}
	}
	return nil
}
...
// SetState sets the "state" field.
func (u *BotUpsert) SetState(v int) *BotUpsert {
	u.Set(bot.FieldState, v)
	return u
}

// UpdateState sets the "state" field to the value that was provided on create.
func (u *BotUpsert) UpdateState() *BotUpsert {
	u.SetExcluded(bot.FieldState)
	return u
}

// AddState adds v to the "state" field.
func (u *BotUpsert) AddState(v int) *BotUpsert {
	u.Add(bot.FieldState, v)
	return u
}
...
// SetState sets the "state" field.
func (u *BotUpsertOne) SetState(v int) *BotUpsertOne {
	return u.Update(func(s *BotUpsert) {
		s.SetState(v)
	})
}
...
// AddState adds v to the "state" field.
func (u *BotUpsertOne) AddState(v int) *BotUpsertOne {
	return u.Update(func(s *BotUpsert) {
		s.AddState(v)
	})
}
...
// UpdateState sets the "state" field to the value that was provided on create.
func (u *BotUpsertOne) UpdateState() *BotUpsertOne {
	return u.Update(func(s *BotUpsert) {
		s.UpdateState()
	})
}
...
func (u *BotUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("gen: missing options for BotCreate.OnConflict")
	}
...
func (u *BotUpsertOne) ID(ctx context.Context) (id int64, err error) {
...
func (u *BotUpsertOne) IDX(ctx context.Context) int64 {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetState sets the "state" field.
func (u *BotUpsertBulk) SetState(v int) *BotUpsertBulk {
	return u.Update(func(s *BotUpsert) {
		s.SetState(v)
	})
}
...
// AddState adds v to the "state" field.
func (u *BotUpsertBulk) AddState(v int) *BotUpsertBulk {
	return u.Update(func(s *BotUpsert) {
		s.AddState(v)
	})
}
...
// UpdateState sets the "state" field to the value that was provided on create.
func (u *BotUpsertBulk) UpdateState() *BotUpsertBulk {
	return u.Update(func(s *BotUpsert) {
		s.UpdateState()
	})
}
...
func (u *BotUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("gen: OnConflict was set for builder %d. Set it on the BotCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("gen: missing options for BotCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
