...
func (c *Client) init() {
	...
	c.FlowEdge = NewFlowEdgeClient(c.config)
	c.FlowJob = NewFlowJobClient(c.config)
	c.FlowNode = NewFlowNodeClient(c.config)
	c.Form = NewFormClient(c.config)
	c.Instruct = NewInstructClient(c.config)
	c.Job = NewJobClient(c.config)
	c.KeyResult = NewKeyResultClient(c.config)
	c.KeyResultValue = NewKeyResultValueClient(c.config)
...
func Open(driverName, dataSourceName string, options ...Option) (*Client, error) {
	switch driverName {
	case dialect.PostgreSQL, dialect.Postgres, dialect.SQLite:
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		FlowEdge:            NewFlowEdgeClient(cfg),
		FlowJob:             NewFlowJobClient(cfg),
		FlowNode:            NewFlowNodeClient(cfg),
		Form:                NewFormClient(cfg),
		Instruct:            NewInstructClient(cfg),
		Job:                 NewJobClient(cfg),
		KeyResult:           NewKeyResultClient(cfg),
		KeyResultValue:      NewKeyResultValueClient(cfg),
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *FlowEdgeMutation:
		return c.FlowEdge.mutate(ctx, m)
	case *FlowJobMutation:
		return c.FlowJob.mutate(ctx, m)
	case *FlowNodeMutation:
		return c.FlowNode.mutate(ctx, m)
	case *FormMutation:
	...
	case *KeyResultMutation:
		return c.KeyResult.mutate(ctx, m)
	case *KeyResultValueMutation:
		return c.KeyResultValue.mutate(ctx, m)
	...
	case *ReviewEvaluationMutation:
		return c.ReviewEvaluation.mutate(ctx, m)
	case *StepMutation:
	...
	case *WorkflowScriptMutation:
		return c.WorkflowScript.mutate(ctx, m)
...
// UpdateOneID returns an update builder for the given id.
func (c *CycleClient) UpdateOneID(id int64) *CycleUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *CycleClient) DeleteOneID(id int64) *CycleDeleteOne {
...
func (c *CycleClient) Get(ctx context.Context, id int64) (*Cycle, error) {
	return c.Query().Where(cycle.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *CycleClient) GetX(ctx context.Context, id int64) *Cycle {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *CycleClient) mutate(ctx context.Context, m *CycleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown Cycle mutation op: %q", m.Op())
	}
}

// DagClient is a client for the Dag schema.
type DagClient struct {
	config
}

// NewDagClient returns a client for the Dag from the given config.
func NewDagClient(c config) *DagClient {
	return &DagClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `dag.Hooks(f(g(h())))`.
func (c *DagClient) Use(hooks ...Hook) {
	c.hooks.Dag = append(c.hooks.Dag, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `dag.Intercept(f(g(h())))`.
func (c *DagClient) Intercept(interceptors ...Interceptor) {
	c.inters.Dag = append(c.inters.Dag, interceptors...)
}

// Create returns a builder for creating a Dag entity.
func (c *DagClient) Create() *DagCreate {
	mutation := newDagMutation(c.config, OpCreate)
	return &DagCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of Dag entities.
func (c *DagClient) CreateBulk(builders ...*DagCreate) *DagCreateBulk {
	return &DagCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *DagClient) MapCreateBulk(slice any, setFunc func(*DagCreate, int)) *DagCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &DagCreateBulk{err: fmt.Errorf("calling to DagClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*DagCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for Dag.
func (c *DagClient) Update() *DagUpdate {
	mutation := newDagMutation(c.config, OpUpdate)
	return &DagUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *DagClient) UpdateOne(_m *Dag) *DagUpdateOne {
	mutation := newDagMutation(c.config, OpUpdateOne, withDag(_m))
	return &DagUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *DagClient) UpdateOneID(id int64) *DagUpdateOne {
	mutation := newDagMutation(c.config, OpUpdateOne, withDagID(id))
	return &DagUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for Dag.
func (c *DagClient) Delete() *DagDelete {
	mutation := newDagMutation(c.config, OpDelete)
	return &DagDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *DagClient) DeleteOne(_m *Dag) *DagDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *DagClient) DeleteOneID(id int64) *DagDeleteOne {
	builder := c.Delete().Where(dag.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &DagDeleteOne{builder}
}

// Query returns a query builder for Dag.
func (c *DagClient) Query() *DagQuery {
	return &DagQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeDag},
		inters: c.Interceptors(),
	}
}

// Get returns a Dag entity by its id.
func (c *DagClient) Get(ctx context.Context, id int64) (*Dag, error) {
	return c.Query().Where(dag.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *DagClient) GetX(ctx context.Context, id int64) *Dag {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryWorkflow queries the workflow edge of a Dag.
func (c *DagClient) QueryWorkflow(_m *Dag) *WorkflowQuery {
	query := (&WorkflowClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(dag.Table, dag.FieldID, id),
...
// Hooks returns the client hooks.
func (c *DagClient) Hooks() []Hook {
	return c.hooks.Dag
}

// Interceptors returns the client interceptors.
func (c *DagClient) Interceptors() []Interceptor {
	return c.inters.Dag
}

func (c *DagClient) mutate(ctx context.Context, m *DagMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&DagCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&DagUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&DagUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&DagDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown Dag mutation op: %q", m.Op())
	}
}
...
func (c *ExecutionClient) mutate(ctx context.Context, m *ExecutionMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown Execution mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *FlowClient) UpdateOneID(id int64) *FlowUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *FlowClient) DeleteOneID(id int64) *FlowDeleteOne {
...
func (c *FlowClient) Get(ctx context.Context, id int64) (*Flow, error) {
	return c.Query().Where(flow.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *FlowClient) GetX(ctx context.Context, id int64) *Flow {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *FlowClient) mutate(ctx context.Context, m *FlowMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown Flow mutation op: %q", m.Op())
	}
}

// FlowEdgeClient is a client for the FlowEdge schema.
type FlowEdgeClient struct {
	config
}

// NewFlowEdgeClient returns a client for the FlowEdge from the given config.
func NewFlowEdgeClient(c config) *FlowEdgeClient {
	return &FlowEdgeClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `flowedge.Hooks(f(g(h())))`.
func (c *FlowEdgeClient) Use(hooks ...Hook) {
	c.hooks.FlowEdge = append(c.hooks.FlowEdge, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `flowedge.Intercept(f(g(h())))`.
func (c *FlowEdgeClient) Intercept(interceptors ...Interceptor) {
	c.inters.FlowEdge = append(c.inters.FlowEdge, interceptors...)
}

// Create returns a builder for creating a FlowEdge entity.
func (c *FlowEdgeClient) Create() *FlowEdgeCreate {
	mutation := newFlowEdgeMutation(c.config, OpCreate)
	return &FlowEdgeCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of FlowEdge entities.
func (c *FlowEdgeClient) CreateBulk(builders ...*FlowEdgeCreate) *FlowEdgeCreateBulk {
	return &FlowEdgeCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *FlowEdgeClient) MapCreateBulk(slice any, setFunc func(*FlowEdgeCreate, int)) *FlowEdgeCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &FlowEdgeCreateBulk{err: fmt.Errorf("calling to FlowEdgeClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*FlowEdgeCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for FlowEdge.
func (c *FlowEdgeClient) Update() *FlowEdgeUpdate {
	mutation := newFlowEdgeMutation(c.config, OpUpdate)
	return &FlowEdgeUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *FlowEdgeClient) UpdateOne(_m *FlowEdge) *FlowEdgeUpdateOne {
	mutation := newFlowEdgeMutation(c.config, OpUpdateOne, withFlowEdge(_m))
	return &FlowEdgeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *FlowEdgeClient) UpdateOneID(id int64) *FlowEdgeUpdateOne {
	mutation := newFlowEdgeMutation(c.config, OpUpdateOne, withFlowEdgeID(id))
	return &FlowEdgeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for FlowEdge.
func (c *FlowEdgeClient) Delete() *FlowEdgeDelete {
	mutation := newFlowEdgeMutation(c.config, OpDelete)
	return &FlowEdgeDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *FlowEdgeClient) DeleteOne(_m *FlowEdge) *FlowEdgeDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *FlowEdgeClient) DeleteOneID(id int64) *FlowEdgeDeleteOne {
	builder := c.Delete().Where(flowedge.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &FlowEdgeDeleteOne{builder}
}

// Query returns a query builder for FlowEdge.
func (c *FlowEdgeClient) Query() *FlowEdgeQuery {
	return &FlowEdgeQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeFlowEdge},
		inters: c.Interceptors(),
	}
}

// Get returns a FlowEdge entity by its id.
func (c *FlowEdgeClient) Get(ctx context.Context, id int64) (*FlowEdge, error) {
	return c.Query().Where(flowedge.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *FlowEdgeClient) GetX(ctx context.Context, id int64) *FlowEdge {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *FlowEdgeClient) Hooks() []Hook {
	return c.hooks.FlowEdge
}

// Interceptors returns the client interceptors.
func (c *FlowEdgeClient) Interceptors() []Interceptor {
	return c.inters.FlowEdge
}

func (c *FlowEdgeClient) mutate(ctx context.Context, m *FlowEdgeMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&FlowEdgeCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&FlowEdgeUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&FlowEdgeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&FlowEdgeDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown FlowEdge mutation op: %q", m.Op())
	}
}

// FlowJobClient is a client for the FlowJob schema.
type FlowJobClient struct {
	config
}

// NewFlowJobClient returns a client for the FlowJob from the given config.
func NewFlowJobClient(c config) *FlowJobClient {
	return &FlowJobClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `flowjob.Hooks(f(g(h())))`.
func (c *FlowJobClient) Use(hooks ...Hook) {
	c.hooks.FlowJob = append(c.hooks.FlowJob, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `flowjob.Intercept(f(g(h())))`.
func (c *FlowJobClient) Intercept(interceptors ...Interceptor) {
	c.inters.FlowJob = append(c.inters.FlowJob, interceptors...)
}

// Create returns a builder for creating a FlowJob entity.
func (c *FlowJobClient) Create() *FlowJobCreate {
	mutation := newFlowJobMutation(c.config, OpCreate)
	return &FlowJobCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of FlowJob entities.
func (c *FlowJobClient) CreateBulk(builders ...*FlowJobCreate) *FlowJobCreateBulk {
	return &FlowJobCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *FlowJobClient) MapCreateBulk(slice any, setFunc func(*FlowJobCreate, int)) *FlowJobCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &FlowJobCreateBulk{err: fmt.Errorf("calling to FlowJobClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*FlowJobCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for FlowJob.
func (c *FlowJobClient) Update() *FlowJobUpdate {
	mutation := newFlowJobMutation(c.config, OpUpdate)
	return &FlowJobUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *FlowJobClient) UpdateOne(_m *FlowJob) *FlowJobUpdateOne {
	mutation := newFlowJobMutation(c.config, OpUpdateOne, withFlowJob(_m))
	return &FlowJobUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *FlowJobClient) UpdateOneID(id int64) *FlowJobUpdateOne {
	mutation := newFlowJobMutation(c.config, OpUpdateOne, withFlowJobID(id))
	return &FlowJobUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for FlowJob.
func (c *FlowJobClient) Delete() *FlowJobDelete {
	mutation := newFlowJobMutation(c.config, OpDelete)
	return &FlowJobDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *FlowJobClient) DeleteOne(_m *FlowJob) *FlowJobDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *FlowJobClient) DeleteOneID(id int64) *FlowJobDeleteOne {
	builder := c.Delete().Where(flowjob.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &FlowJobDeleteOne{builder}
}

// Query returns a query builder for FlowJob.
func (c *FlowJobClient) Query() *FlowJobQuery {
	return &FlowJobQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeFlowJob},
		inters: c.Interceptors(),
	}
}

// Get returns a FlowJob entity by its id.
func (c *FlowJobClient) Get(ctx context.Context, id int64) (*FlowJob, error) {
	return c.Query().Where(flowjob.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *FlowJobClient) GetX(ctx context.Context, id int64) *FlowJob {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *FlowJobClient) Hooks() []Hook {
	return c.hooks.FlowJob
}

// Interceptors returns the client interceptors.
func (c *FlowJobClient) Interceptors() []Interceptor {
	return c.inters.FlowJob
}

func (c *FlowJobClient) mutate(ctx context.Context, m *FlowJobMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&FlowJobCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&FlowJobUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&FlowJobUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&FlowJobDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown FlowJob mutation op: %q", m.Op())
	}
}

// FlowNodeClient is a client for the FlowNode schema.
type FlowNodeClient struct {
	config
}

// NewFlowNodeClient returns a client for the FlowNode from the given config.
func NewFlowNodeClient(c config) *FlowNodeClient {
	return &FlowNodeClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `flownode.Hooks(f(g(h())))`.
func (c *FlowNodeClient) Use(hooks ...Hook) {
	c.hooks.FlowNode = append(c.hooks.FlowNode, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `flownode.Intercept(f(g(h())))`.
func (c *FlowNodeClient) Intercept(interceptors ...Interceptor) {
	c.inters.FlowNode = append(c.inters.FlowNode, interceptors...)
}

// Create returns a builder for creating a FlowNode entity.
func (c *FlowNodeClient) Create() *FlowNodeCreate {
	mutation := newFlowNodeMutation(c.config, OpCreate)
	return &FlowNodeCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of FlowNode entities.
func (c *FlowNodeClient) CreateBulk(builders ...*FlowNodeCreate) *FlowNodeCreateBulk {
	return &FlowNodeCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *FlowNodeClient) MapCreateBulk(slice any, setFunc func(*FlowNodeCreate, int)) *FlowNodeCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &FlowNodeCreateBulk{err: fmt.Errorf("calling to FlowNodeClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*FlowNodeCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for FlowNode.
func (c *FlowNodeClient) Update() *FlowNodeUpdate {
	mutation := newFlowNodeMutation(c.config, OpUpdate)
	return &FlowNodeUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *FlowNodeClient) UpdateOne(_m *FlowNode) *FlowNodeUpdateOne {
	mutation := newFlowNodeMutation(c.config, OpUpdateOne, withFlowNode(_m))
	return &FlowNodeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *FlowNodeClient) UpdateOneID(id int64) *FlowNodeUpdateOne {
	mutation := newFlowNodeMutation(c.config, OpUpdateOne, withFlowNodeID(id))
	return &FlowNodeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for FlowNode.
func (c *FlowNodeClient) Delete() *FlowNodeDelete {
	mutation := newFlowNodeMutation(c.config, OpDelete)
	return &FlowNodeDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *FlowNodeClient) DeleteOne(_m *FlowNode) *FlowNodeDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *FlowNodeClient) DeleteOneID(id int64) *FlowNodeDeleteOne {
	builder := c.Delete().Where(flownode.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &FlowNodeDeleteOne{builder}
}

// Query returns a query builder for FlowNode.
func (c *FlowNodeClient) Query() *FlowNodeQuery {
	return &FlowNodeQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeFlowNode},
		inters: c.Interceptors(),
	}
}

// Get returns a FlowNode entity by its id.
func (c *FlowNodeClient) Get(ctx context.Context, id int64) (*FlowNode, error) {
	return c.Query().Where(flownode.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *FlowNodeClient) GetX(ctx context.Context, id int64) *FlowNode {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *FlowNodeClient) Hooks() []Hook {
	return c.hooks.FlowNode
}

// Interceptors returns the client interceptors.
func (c *FlowNodeClient) Interceptors() []Interceptor {
	return c.inters.FlowNode
}

func (c *FlowNodeClient) mutate(ctx context.Context, m *FlowNodeMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&FlowNodeCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&FlowNodeUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&FlowNodeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&FlowNodeDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown FlowNode mutation op: %q", m.Op())
	}
}
...
// QuerySteps queries the steps edge of a Job.
func (c *JobClient) QuerySteps(_m *Job) *StepQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, job.StepsTable, job.StepsColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// KeyResultClient is a client for the KeyResult schema.
type KeyResultClient struct {
	config
}

// NewKeyResultClient returns a client for the KeyResult from the given config.
func NewKeyResultClient(c config) *KeyResultClient {
	return &KeyResultClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `keyresult.Hooks(f(g(h())))`.
func (c *KeyResultClient) Use(hooks ...Hook) {
	c.hooks.KeyResult = append(c.hooks.KeyResult, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `keyresult.Intercept(f(g(h())))`.
func (c *KeyResultClient) Intercept(interceptors ...Interceptor) {
	c.inters.KeyResult = append(c.inters.KeyResult, interceptors...)
}

// Create returns a builder for creating a KeyResult entity.
func (c *KeyResultClient) Create() *KeyResultCreate {
	mutation := newKeyResultMutation(c.config, OpCreate)
	return &KeyResultCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of KeyResult entities.
func (c *KeyResultClient) CreateBulk(builders ...*KeyResultCreate) *KeyResultCreateBulk {
	return &KeyResultCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *KeyResultClient) MapCreateBulk(slice any, setFunc func(*KeyResultCreate, int)) *KeyResultCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &KeyResultCreateBulk{err: fmt.Errorf("calling to KeyResultClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*KeyResultCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for KeyResult.
func (c *KeyResultClient) Update() *KeyResultUpdate {
	mutation := newKeyResultMutation(c.config, OpUpdate)
	return &KeyResultUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *KeyResultClient) UpdateOne(_m *KeyResult) *KeyResultUpdateOne {
	mutation := newKeyResultMutation(c.config, OpUpdateOne, withKeyResult(_m))
	return &KeyResultUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *KeyResultClient) UpdateOneID(id int64) *KeyResultUpdateOne {
	mutation := newKeyResultMutation(c.config, OpUpdateOne, withKeyResultID(id))
	return &KeyResultUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for KeyResult.
func (c *KeyResultClient) Delete() *KeyResultDelete {
	mutation := newKeyResultMutation(c.config, OpDelete)
	return &KeyResultDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *KeyResultClient) DeleteOne(_m *KeyResult) *KeyResultDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *KeyResultClient) DeleteOneID(id int64) *KeyResultDeleteOne {
	builder := c.Delete().Where(keyresult.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &KeyResultDeleteOne{builder}
}

// Query returns a query builder for KeyResult.
func (c *KeyResultClient) Query() *KeyResultQuery {
	return &KeyResultQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeKeyResult},
		inters: c.Interceptors(),
	}
}

// Get returns a KeyResult entity by its id.
func (c *KeyResultClient) Get(ctx context.Context, id int64) (*KeyResult, error) {
	return c.Query().Where(keyresult.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *KeyResultClient) GetX(ctx context.Context, id int64) *KeyResult {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryObjective queries the objective edge of a KeyResult.
func (c *KeyResultClient) QueryObjective(_m *KeyResult) *ObjectiveQuery {
	query := (&ObjectiveClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(keyresult.Table, keyresult.FieldID, id),
...
// QueryKeyResultValues queries the key_result_values edge of a KeyResult.
func (c *KeyResultClient) QueryKeyResultValues(_m *KeyResult) *KeyResultValueQuery {
	query := (&KeyResultValueClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(keyresult.Table, keyresult.FieldID, id),
...
// QueryTodos queries the todos edge of a KeyResult.
func (c *KeyResultClient) QueryTodos(_m *KeyResult) *TodoQuery {
...
// Hooks returns the client hooks.
func (c *KeyResultClient) Hooks() []Hook {
	return c.hooks.KeyResult
}

// Interceptors returns the client interceptors.
func (c *KeyResultClient) Interceptors() []Interceptor {
	return c.inters.KeyResult
}

func (c *KeyResultClient) mutate(ctx context.Context, m *KeyResultMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&KeyResultCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&KeyResultUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&KeyResultUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&KeyResultDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown KeyResult mutation op: %q", m.Op())
	}
}

// KeyResultValueClient is a client for the KeyResultValue schema.
type KeyResultValueClient struct {
	config
}

// NewKeyResultValueClient returns a client for the KeyResultValue from the given config.
func NewKeyResultValueClient(c config) *KeyResultValueClient {
	return &KeyResultValueClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `keyresultvalue.Hooks(f(g(h())))`.
func (c *KeyResultValueClient) Use(hooks ...Hook) {
	c.hooks.KeyResultValue = append(c.hooks.KeyResultValue, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `keyresultvalue.Intercept(f(g(h())))`.
func (c *KeyResultValueClient) Intercept(interceptors ...Interceptor) {
	c.inters.KeyResultValue = append(c.inters.KeyResultValue, interceptors...)
}

// Create returns a builder for creating a KeyResultValue entity.
func (c *KeyResultValueClient) Create() *KeyResultValueCreate {
	mutation := newKeyResultValueMutation(c.config, OpCreate)
	return &KeyResultValueCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of KeyResultValue entities.
func (c *KeyResultValueClient) CreateBulk(builders ...*KeyResultValueCreate) *KeyResultValueCreateBulk {
	return &KeyResultValueCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *KeyResultValueClient) MapCreateBulk(slice any, setFunc func(*KeyResultValueCreate, int)) *KeyResultValueCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &KeyResultValueCreateBulk{err: fmt.Errorf("calling to KeyResultValueClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*KeyResultValueCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for KeyResultValue.
func (c *KeyResultValueClient) Update() *KeyResultValueUpdate {
	mutation := newKeyResultValueMutation(c.config, OpUpdate)
	return &KeyResultValueUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *KeyResultValueClient) UpdateOne(_m *KeyResultValue) *KeyResultValueUpdateOne {
	mutation := newKeyResultValueMutation(c.config, OpUpdateOne, withKeyResultValue(_m))
	return &KeyResultValueUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *KeyResultValueClient) UpdateOneID(id int64) *KeyResultValueUpdateOne {
	mutation := newKeyResultValueMutation(c.config, OpUpdateOne, withKeyResultValueID(id))
	return &KeyResultValueUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for KeyResultValue.
func (c *KeyResultValueClient) Delete() *KeyResultValueDelete {
	mutation := newKeyResultValueMutation(c.config, OpDelete)
	return &KeyResultValueDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *KeyResultValueClient) DeleteOne(_m *KeyResultValue) *KeyResultValueDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *KeyResultValueClient) DeleteOneID(id int64) *KeyResultValueDeleteOne {
	builder := c.Delete().Where(keyresultvalue.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &KeyResultValueDeleteOne{builder}
}

// Query returns a query builder for KeyResultValue.
func (c *KeyResultValueClient) Query() *KeyResultValueQuery {
	return &KeyResultValueQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeKeyResultValue},
		inters: c.Interceptors(),
	}
}

// Get returns a KeyResultValue entity by its id.
func (c *KeyResultValueClient) Get(ctx context.Context, id int64) (*KeyResultValue, error) {
	return c.Query().Where(keyresultvalue.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *KeyResultValueClient) GetX(ctx context.Context, id int64) *KeyResultValue {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryKeyResult queries the key_result edge of a KeyResultValue.
func (c *KeyResultValueClient) QueryKeyResult(_m *KeyResultValue) *KeyResultQuery {
	query := (&KeyResultClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(keyresultvalue.Table, keyresultvalue.FieldID, id),
...
// Hooks returns the client hooks.
func (c *KeyResultValueClient) Hooks() []Hook {
	return c.hooks.KeyResultValue
}

// Interceptors returns the client interceptors.
func (c *KeyResultValueClient) Interceptors() []Interceptor {
	return c.inters.KeyResultValue
}

func (c *KeyResultValueClient) mutate(ctx context.Context, m *KeyResultValueMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&KeyResultValueCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&KeyResultValueUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&KeyResultValueUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&KeyResultValueDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown KeyResultValue mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *ObjectiveClient) UpdateOneID(id int64) *ObjectiveUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ObjectiveClient) DeleteOneID(id int64) *ObjectiveDeleteOne {
...
func (c *ObjectiveClient) Get(ctx context.Context, id int64) (*Objective, error) {
	return c.Query().Where(objective.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ObjectiveClient) GetX(ctx context.Context, id int64) *Objective {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryKeyResults queries the key_results edge of a Objective.
func (c *ObjectiveClient) QueryKeyResults(_m *Objective) *KeyResultQuery {
	query := (&KeyResultClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryReviews queries the reviews edge of a Objective.
func (c *ObjectiveClient) QueryReviews(_m *Objective) *ReviewQuery {
...
func (c *ObjectiveClient) mutate(ctx context.Context, m *ObjectiveMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown Objective mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *RateLimitClient) UpdateOneID(id int64) *RateLimitUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *RateLimitClient) DeleteOneID(id int64) *RateLimitDeleteOne {
...
func (c *RateLimitClient) Get(ctx context.Context, id int64) (*RateLimit, error) {
	return c.Query().Where(ratelimit.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *RateLimitClient) GetX(ctx context.Context, id int64) *RateLimit {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *RateLimitClient) mutate(ctx context.Context, m *RateLimitMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown RateLimit mutation op: %q", m.Op())
	}
}
...
// QueryObjective queries the objective edge of a Review.
func (c *ReviewClient) QueryObjective(_m *Review) *ObjectiveQuery {
	query := (&ObjectiveClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(objective.Table, objective.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, review.ObjectiveTable, review.ObjectiveColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryEvaluations queries the evaluations edge of a Review.
func (c *ReviewClient) QueryEvaluations(_m *Review) *ReviewEvaluationQuery {
	query := (&ReviewEvaluationClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(review.Table, review.FieldID, id),
			sqlgraph.To(reviewevaluation.Table, reviewevaluation.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, review.EvaluationsTable, review.EvaluationsColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// ReviewEvaluationClient is a client for the ReviewEvaluation schema.
type ReviewEvaluationClient struct {
	config
}

// NewReviewEvaluationClient returns a client for the ReviewEvaluation from the given config.
func NewReviewEvaluationClient(c config) *ReviewEvaluationClient {
	return &ReviewEvaluationClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `reviewevaluation.Hooks(f(g(h())))`.
func (c *ReviewEvaluationClient) Use(hooks ...Hook) {
	c.hooks.ReviewEvaluation = append(c.hooks.ReviewEvaluation, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `reviewevaluation.Intercept(f(g(h())))`.
func (c *ReviewEvaluationClient) Intercept(interceptors ...Interceptor) {
	c.inters.ReviewEvaluation = append(c.inters.ReviewEvaluation, interceptors...)
}

// Create returns a builder for creating a ReviewEvaluation entity.
func (c *ReviewEvaluationClient) Create() *ReviewEvaluationCreate {
	mutation := newReviewEvaluationMutation(c.config, OpCreate)
	return &ReviewEvaluationCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of ReviewEvaluation entities.
func (c *ReviewEvaluationClient) CreateBulk(builders ...*ReviewEvaluationCreate) *ReviewEvaluationCreateBulk {
	return &ReviewEvaluationCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *ReviewEvaluationClient) MapCreateBulk(slice any, setFunc func(*ReviewEvaluationCreate, int)) *ReviewEvaluationCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ReviewEvaluationCreateBulk{err: fmt.Errorf("calling to ReviewEvaluationClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*ReviewEvaluationCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for ReviewEvaluation.
func (c *ReviewEvaluationClient) Update() *ReviewEvaluationUpdate {
	mutation := newReviewEvaluationMutation(c.config, OpUpdate)
	return &ReviewEvaluationUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *ReviewEvaluationClient) UpdateOne(_m *ReviewEvaluation) *ReviewEvaluationUpdateOne {
	mutation := newReviewEvaluationMutation(c.config, OpUpdateOne, withReviewEvaluation(_m))
	return &ReviewEvaluationUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *ReviewEvaluationClient) UpdateOneID(id int64) *ReviewEvaluationUpdateOne {
	mutation := newReviewEvaluationMutation(c.config, OpUpdateOne, withReviewEvaluationID(id))
	return &ReviewEvaluationUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for ReviewEvaluation.
func (c *ReviewEvaluationClient) Delete() *ReviewEvaluationDelete {
	mutation := newReviewEvaluationMutation(c.config, OpDelete)
	return &ReviewEvaluationDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *ReviewEvaluationClient) DeleteOne(_m *ReviewEvaluation) *ReviewEvaluationDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ReviewEvaluationClient) DeleteOneID(id int64) *ReviewEvaluationDeleteOne {
	builder := c.Delete().Where(reviewevaluation.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ReviewEvaluationDeleteOne{builder}
}

// Query returns a query builder for ReviewEvaluation.
func (c *ReviewEvaluationClient) Query() *ReviewEvaluationQuery {
	return &ReviewEvaluationQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeReviewEvaluation},
		inters: c.Interceptors(),
	}
}

// Get returns a ReviewEvaluation entity by its id.
func (c *ReviewEvaluationClient) Get(ctx context.Context, id int64) (*ReviewEvaluation, error) {
	return c.Query().Where(reviewevaluation.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ReviewEvaluationClient) GetX(ctx context.Context, id int64) *ReviewEvaluation {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryReview queries the review edge of a ReviewEvaluation.
func (c *ReviewEvaluationClient) QueryReview(_m *ReviewEvaluation) *ReviewQuery {
	query := (&ReviewClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(reviewevaluation.Table, reviewevaluation.FieldID, id),
			sqlgraph.To(review.Table, review.FieldID),
...
// Hooks returns the client hooks.
func (c *ReviewEvaluationClient) Hooks() []Hook {
	return c.hooks.ReviewEvaluation
}

// Interceptors returns the client interceptors.
func (c *ReviewEvaluationClient) Interceptors() []Interceptor {
	return c.inters.ReviewEvaluation
}

func (c *ReviewEvaluationClient) mutate(ctx context.Context, m *ReviewEvaluationMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ReviewEvaluationCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&ReviewEvaluationUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&ReviewEvaluationUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ReviewEvaluationDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown ReviewEvaluation mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *StepClient) UpdateOneID(id int64) *StepUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *StepClient) DeleteOneID(id int64) *StepDeleteOne {
...
func (c *StepClient) Get(ctx context.Context, id int64) (*Step, error) {
	return c.Query().Where(step.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *StepClient) GetX(ctx context.Context, id int64) *Step {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryJob queries the job edge of a Step.
func (c *StepClient) QueryJob(_m *Step) *JobQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, step.JobTable, step.JobColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *StepClient) mutate(ctx context.Context, m *StepMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown Step mutation op: %q", m.Op())
	}
}
...
// QueryKeyResult queries the key_result edge of a Todo.
func (c *TodoClient) QueryKeyResult(_m *Todo) *KeyResultQuery {
	query := (&KeyResultClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(keyresult.Table, keyresult.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, todo.KeyResultTable, todo.KeyResultColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QuerySubTodos queries the sub_todos edge of a Todo.
func (c *TodoClient) QuerySubTodos(_m *Todo) *TodoQuery {
	query := (&TodoClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(todo.Table, todo.FieldID, id),
			sqlgraph.To(todo.Table, todo.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, todo.SubTodosTable, todo.SubTodosColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *TodoClient) mutate(ctx context.Context, m *TodoMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown Todo mutation op: %q", m.Op())
	}
}
...
// QueryDag queries the dag edge of a Workflow.
func (c *WorkflowClient) QueryDag(_m *Workflow) *DagQuery {
	query := (&DagClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(workflow.Table, workflow.FieldID, id),
			sqlgraph.To(dag.Table, dag.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, workflow.DagTable, workflow.DagColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryTriggers queries the triggers edge of a Workflow.
func (c *WorkflowClient) QueryTriggers(_m *Workflow) *WorkflowTriggerQuery {
	query := (&WorkflowTriggerClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(workflow.Table, workflow.FieldID, id),
			sqlgraph.To(workflowtrigger.Table, workflowtrigger.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, workflow.TriggersTable, workflow.TriggersColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// WorkflowScriptClient is a client for the WorkflowScript schema.
type WorkflowScriptClient struct {
	config
}

// NewWorkflowScriptClient returns a client for the WorkflowScript from the given config.
func NewWorkflowScriptClient(c config) *WorkflowScriptClient {
	return &WorkflowScriptClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `workflowscript.Hooks(f(g(h())))`.
func (c *WorkflowScriptClient) Use(hooks ...Hook) {
	c.hooks.WorkflowScript = append(c.hooks.WorkflowScript, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `workflowscript.Intercept(f(g(h())))`.
func (c *WorkflowScriptClient) Intercept(interceptors ...Interceptor) {
	c.inters.WorkflowScript = append(c.inters.WorkflowScript, interceptors...)
}

// Create returns a builder for creating a WorkflowScript entity.
func (c *WorkflowScriptClient) Create() *WorkflowScriptCreate {
	mutation := newWorkflowScriptMutation(c.config, OpCreate)
	return &WorkflowScriptCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of WorkflowScript entities.
func (c *WorkflowScriptClient) CreateBulk(builders ...*WorkflowScriptCreate) *WorkflowScriptCreateBulk {
	return &WorkflowScriptCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *WorkflowScriptClient) MapCreateBulk(slice any, setFunc func(*WorkflowScriptCreate, int)) *WorkflowScriptCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &WorkflowScriptCreateBulk{err: fmt.Errorf("calling to WorkflowScriptClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*WorkflowScriptCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for WorkflowScript.
func (c *WorkflowScriptClient) Update() *WorkflowScriptUpdate {
	mutation := newWorkflowScriptMutation(c.config, OpUpdate)
	return &WorkflowScriptUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *WorkflowScriptClient) UpdateOne(_m *WorkflowScript) *WorkflowScriptUpdateOne {
	mutation := newWorkflowScriptMutation(c.config, OpUpdateOne, withWorkflowScript(_m))
	return &WorkflowScriptUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *WorkflowScriptClient) UpdateOneID(id int64) *WorkflowScriptUpdateOne {
	mutation := newWorkflowScriptMutation(c.config, OpUpdateOne, withWorkflowScriptID(id))
	return &WorkflowScriptUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for WorkflowScript.
func (c *WorkflowScriptClient) Delete() *WorkflowScriptDelete {
	mutation := newWorkflowScriptMutation(c.config, OpDelete)
	return &WorkflowScriptDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *WorkflowScriptClient) DeleteOne(_m *WorkflowScript) *WorkflowScriptDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *WorkflowScriptClient) DeleteOneID(id int64) *WorkflowScriptDeleteOne {
	builder := c.Delete().Where(workflowscript.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &WorkflowScriptDeleteOne{builder}
}

// Query returns a query builder for WorkflowScript.
func (c *WorkflowScriptClient) Query() *WorkflowScriptQuery {
	return &WorkflowScriptQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeWorkflowScript},
		inters: c.Interceptors(),
	}
}

// Get returns a WorkflowScript entity by its id.
func (c *WorkflowScriptClient) Get(ctx context.Context, id int64) (*WorkflowScript, error) {
	return c.Query().Where(workflowscript.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *WorkflowScriptClient) GetX(ctx context.Context, id int64) *WorkflowScript {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *WorkflowScriptClient) Hooks() []Hook {
	return c.hooks.WorkflowScript
}

// Interceptors returns the client interceptors.
func (c *WorkflowScriptClient) Interceptors() []Interceptor {
	return c.inters.WorkflowScript
}

func (c *WorkflowScriptClient) mutate(ctx context.Context, m *WorkflowScriptMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&WorkflowScriptCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&WorkflowScriptUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&WorkflowScriptUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&WorkflowScriptDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown WorkflowScript mutation op: %q", m.Op())
	}
}
...
// QueryWorkflow queries the workflow edge of a WorkflowTrigger.
func (c *WorkflowTriggerClient) QueryWorkflow(_m *WorkflowTrigger) *WorkflowQuery {
	query := (&WorkflowClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(workflowtrigger.Table, workflowtrigger.FieldID, id),
			sqlgraph.To(workflow.Table, workflow.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, workflowtrigger.WorkflowTable, workflowtrigger.WorkflowColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
