...
type Client struct {
	...
	// AgentMemoryFact is the client for interacting with the AgentMemoryFact builders.
	AgentMemoryFact *AgentMemoryFactClient
	// AgentPlan is the client for interacting with the AgentPlan builders.
	AgentPlan *AgentPlanClient
	// AgentSessionSummary is the client for interacting with the AgentSessionSummary builders.
	AgentSessionSummary *AgentSessionSummaryClient
	...
	// AgentSubagentTask is the client for interacting with the AgentSubagentTask builders.
	AgentSubagentTask *AgentSubagentTaskClient
	// AgentTodo is the client for interacting with the AgentTodo builders.
	AgentTodo *AgentTodoClient
...
func (c *Client) init() {
	...
	c.AgentMemoryFact = NewAgentMemoryFactClient(c.config)
	c.AgentPlan = NewAgentPlanClient(c.config)
	c.AgentSessionSummary = NewAgentSessionSummaryClient(c.config)
	c.AgentSkill = NewAgentSkillClient(c.config)
	c.AgentSkillFile = NewAgentSkillFileClient(c.config)
	c.AgentSubagent = NewAgentSubagentClient(c.config)
	c.AgentSubagentTask = NewAgentSubagentTaskClient(c.config)
	...
	c.LifeLootTable = NewLifeLootTableClient(c.config)
	c.LifePlanNode = NewLifePlanNodeClient(c.config)
	c.LifeProfile = NewLifeProfileClient(c.config)
	c.LifeQuest = NewLifeQuestClient(c.config)
	c.LifeReward = NewLifeRewardClient(c.config)
	c.LifeRewardRedemption = NewLifeRewardRedemptionClient(c.config)
	c.LifeSkill = NewLifeSkillClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		AgentMemoryFact:           NewAgentMemoryFactClient(cfg),
		AgentPlan:                 NewAgentPlanClient(cfg),
		AgentSessionSummary:       NewAgentSessionSummaryClient(cfg),
		AgentSkill:                NewAgentSkillClient(cfg),
		AgentSkillFile:            NewAgentSkillFileClient(cfg),
		AgentSubagent:             NewAgentSubagentClient(cfg),
		AgentSubagentTask:         NewAgentSubagentTaskClient(cfg),
		...
		LifeLootTable:             NewLifeLootTableClient(cfg),
		LifePlanNode:              NewLifePlanNodeClient(cfg),
		LifeProfile:               NewLifeProfileClient(cfg),
		LifeQuest:                 NewLifeQuestClient(cfg),
		LifeReward:                NewLifeRewardClient(cfg),
		LifeRewardRedemption:      NewLifeRewardRedemptionClient(cfg),
		LifeSkill:                 NewLifeSkillClient(cfg),
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *AgentMemoryFactMutation:
		return c.AgentMemoryFact.mutate(ctx, m)
	case *AgentPlanMutation:
		return c.AgentPlan.mutate(ctx, m)
	case *AgentSessionSummaryMutation:
		return c.AgentSessionSummary.mutate(ctx, m)
	case *AgentSkillMutation:
		return c.AgentSkill.mutate(ctx, m)
	case *AgentSkillFileMutation:
		return c.AgentSkillFile.mutate(ctx, m)
	case *AgentSubagentMutation:
		return c.AgentSubagent.mutate(ctx, m)
	case *AgentSubagentTaskMutation:
		return c.AgentSubagentTask.mutate(ctx, m)
	case *AgentTodoMutation:
		return c.AgentTodo.mutate(ctx, m)
	case *AppMutation:
	...
	case *LifeHabitCheckinMutation:
		return c.LifeHabitCheckin.mutate(ctx, m)
	case *LifeInventoryMutation:
		return c.LifeInventory.mutate(ctx, m)
	case *LifeLootTableMutation:
		return c.LifeLootTable.mutate(ctx, m)
	case *LifePlanNodeMutation:
		return c.LifePlanNode.mutate(ctx, m)
	case *LifeProfileMutation:
		return c.LifeProfile.mutate(ctx, m)
	case *LifeQuestMutation:
		return c.LifeQuest.mutate(ctx, m)
	case *LifeRewardMutation:
		return c.LifeReward.mutate(ctx, m)
	case *LifeRewardRedemptionMutation:
		return c.LifeRewardRedemption.mutate(ctx, m)
	case *LifeSkillMutation:
		return c.LifeSkill.mutate(ctx, m)
...
// AgentMemoryFactClient is a client for the AgentMemoryFact schema.
type AgentMemoryFactClient struct {
	config
}

// NewAgentMemoryFactClient returns a client for the AgentMemoryFact from the given config.
func NewAgentMemoryFactClient(c config) *AgentMemoryFactClient {
	return &AgentMemoryFactClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `agentmemoryfact.Hooks(f(g(h())))`.
func (c *AgentMemoryFactClient) Use(hooks ...Hook) {
	c.hooks.AgentMemoryFact = append(c.hooks.AgentMemoryFact, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `agentmemoryfact.Intercept(f(g(h())))`.
func (c *AgentMemoryFactClient) Intercept(interceptors ...Interceptor) {
	c.inters.AgentMemoryFact = append(c.inters.AgentMemoryFact, interceptors...)
}

// Create returns a builder for creating a AgentMemoryFact entity.
func (c *AgentMemoryFactClient) Create() *AgentMemoryFactCreate {
	mutation := newAgentMemoryFactMutation(c.config, OpCreate)
	return &AgentMemoryFactCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of AgentMemoryFact entities.
func (c *AgentMemoryFactClient) CreateBulk(builders ...*AgentMemoryFactCreate) *AgentMemoryFactCreateBulk {
	return &AgentMemoryFactCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *AgentMemoryFactClient) MapCreateBulk(slice any, setFunc func(*AgentMemoryFactCreate, int)) *AgentMemoryFactCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AgentMemoryFactCreateBulk{err: fmt.Errorf("calling to AgentMemoryFactClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*AgentMemoryFactCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for AgentMemoryFact.
func (c *AgentMemoryFactClient) Update() *AgentMemoryFactUpdate {
	mutation := newAgentMemoryFactMutation(c.config, OpUpdate)
	return &AgentMemoryFactUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AgentMemoryFactClient) UpdateOne(_m *AgentMemoryFact) *AgentMemoryFactUpdateOne {
	mutation := newAgentMemoryFactMutation(c.config, OpUpdateOne, withAgentMemoryFact(_m))
	return &AgentMemoryFactUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AgentMemoryFactClient) UpdateOneID(id int64) *AgentMemoryFactUpdateOne {
	mutation := newAgentMemoryFactMutation(c.config, OpUpdateOne, withAgentMemoryFactID(id))
	return &AgentMemoryFactUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AgentMemoryFact.
func (c *AgentMemoryFactClient) Delete() *AgentMemoryFactDelete {
	mutation := newAgentMemoryFactMutation(c.config, OpDelete)
	return &AgentMemoryFactDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *AgentMemoryFactClient) DeleteOne(_m *AgentMemoryFact) *AgentMemoryFactDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AgentMemoryFactClient) DeleteOneID(id int64) *AgentMemoryFactDeleteOne {
	builder := c.Delete().Where(agentmemoryfact.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AgentMemoryFactDeleteOne{builder}
}

// Query returns a query builder for AgentMemoryFact.
func (c *AgentMemoryFactClient) Query() *AgentMemoryFactQuery {
	return &AgentMemoryFactQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAgentMemoryFact},
		inters: c.Interceptors(),
	}
}

// Get returns a AgentMemoryFact entity by its id.
func (c *AgentMemoryFactClient) Get(ctx context.Context, id int64) (*AgentMemoryFact, error) {
	return c.Query().Where(agentmemoryfact.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AgentMemoryFactClient) GetX(ctx context.Context, id int64) *AgentMemoryFact {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *AgentMemoryFactClient) Hooks() []Hook {
	return c.hooks.AgentMemoryFact
}

// Interceptors returns the client interceptors.
func (c *AgentMemoryFactClient) Interceptors() []Interceptor {
	return c.inters.AgentMemoryFact
}

func (c *AgentMemoryFactClient) mutate(ctx context.Context, m *AgentMemoryFactMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AgentMemoryFactCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&AgentMemoryFactUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&AgentMemoryFactUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AgentMemoryFactDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown AgentMemoryFact mutation op: %q", m.Op())
	}
}

// AgentPlanClient is a client for the AgentPlan schema.
type AgentPlanClient struct {
	config
}

// NewAgentPlanClient returns a client for the AgentPlan from the given config.
func NewAgentPlanClient(c config) *AgentPlanClient {
	return &AgentPlanClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `agentplan.Hooks(f(g(h())))`.
func (c *AgentPlanClient) Use(hooks ...Hook) {
	c.hooks.AgentPlan = append(c.hooks.AgentPlan, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `agentplan.Intercept(f(g(h())))`.
func (c *AgentPlanClient) Intercept(interceptors ...Interceptor) {
	c.inters.AgentPlan = append(c.inters.AgentPlan, interceptors...)
}

// Create returns a builder for creating a AgentPlan entity.
func (c *AgentPlanClient) Create() *AgentPlanCreate {
	mutation := newAgentPlanMutation(c.config, OpCreate)
	return &AgentPlanCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of AgentPlan entities.
func (c *AgentPlanClient) CreateBulk(builders ...*AgentPlanCreate) *AgentPlanCreateBulk {
	return &AgentPlanCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *AgentPlanClient) MapCreateBulk(slice any, setFunc func(*AgentPlanCreate, int)) *AgentPlanCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AgentPlanCreateBulk{err: fmt.Errorf("calling to AgentPlanClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*AgentPlanCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for AgentPlan.
func (c *AgentPlanClient) Update() *AgentPlanUpdate {
	mutation := newAgentPlanMutation(c.config, OpUpdate)
	return &AgentPlanUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AgentPlanClient) UpdateOne(_m *AgentPlan) *AgentPlanUpdateOne {
	mutation := newAgentPlanMutation(c.config, OpUpdateOne, withAgentPlan(_m))
	return &AgentPlanUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AgentPlanClient) UpdateOneID(id int64) *AgentPlanUpdateOne {
	mutation := newAgentPlanMutation(c.config, OpUpdateOne, withAgentPlanID(id))
	return &AgentPlanUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AgentPlan.
func (c *AgentPlanClient) Delete() *AgentPlanDelete {
	mutation := newAgentPlanMutation(c.config, OpDelete)
	return &AgentPlanDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *AgentPlanClient) DeleteOne(_m *AgentPlan) *AgentPlanDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AgentPlanClient) DeleteOneID(id int64) *AgentPlanDeleteOne {
	builder := c.Delete().Where(agentplan.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AgentPlanDeleteOne{builder}
}

// Query returns a query builder for AgentPlan.
func (c *AgentPlanClient) Query() *AgentPlanQuery {
	return &AgentPlanQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAgentPlan},
		inters: c.Interceptors(),
	}
}

// Get returns a AgentPlan entity by its id.
func (c *AgentPlanClient) Get(ctx context.Context, id int64) (*AgentPlan, error) {
	return c.Query().Where(agentplan.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AgentPlanClient) GetX(ctx context.Context, id int64) *AgentPlan {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *AgentPlanClient) Hooks() []Hook {
	return c.hooks.AgentPlan
}

// Interceptors returns the client interceptors.
func (c *AgentPlanClient) Interceptors() []Interceptor {
	return c.inters.AgentPlan
}

func (c *AgentPlanClient) mutate(ctx context.Context, m *AgentPlanMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AgentPlanCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&AgentPlanUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&AgentPlanUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AgentPlanDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown AgentPlan mutation op: %q", m.Op())
	}
}

// AgentSessionSummaryClient is a client for the AgentSessionSummary schema.
type AgentSessionSummaryClient struct {
	config
}

// NewAgentSessionSummaryClient returns a client for the AgentSessionSummary from the given config.
func NewAgentSessionSummaryClient(c config) *AgentSessionSummaryClient {
	return &AgentSessionSummaryClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `agentsessionsummary.Hooks(f(g(h())))`.
func (c *AgentSessionSummaryClient) Use(hooks ...Hook) {
	c.hooks.AgentSessionSummary = append(c.hooks.AgentSessionSummary, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `agentsessionsummary.Intercept(f(g(h())))`.
func (c *AgentSessionSummaryClient) Intercept(interceptors ...Interceptor) {
	c.inters.AgentSessionSummary = append(c.inters.AgentSessionSummary, interceptors...)
}

// Create returns a builder for creating a AgentSessionSummary entity.
func (c *AgentSessionSummaryClient) Create() *AgentSessionSummaryCreate {
	mutation := newAgentSessionSummaryMutation(c.config, OpCreate)
	return &AgentSessionSummaryCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of AgentSessionSummary entities.
func (c *AgentSessionSummaryClient) CreateBulk(builders ...*AgentSessionSummaryCreate) *AgentSessionSummaryCreateBulk {
	return &AgentSessionSummaryCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *AgentSessionSummaryClient) MapCreateBulk(slice any, setFunc func(*AgentSessionSummaryCreate, int)) *AgentSessionSummaryCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AgentSessionSummaryCreateBulk{err: fmt.Errorf("calling to AgentSessionSummaryClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*AgentSessionSummaryCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for AgentSessionSummary.
func (c *AgentSessionSummaryClient) Update() *AgentSessionSummaryUpdate {
	mutation := newAgentSessionSummaryMutation(c.config, OpUpdate)
	return &AgentSessionSummaryUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AgentSessionSummaryClient) UpdateOne(_m *AgentSessionSummary) *AgentSessionSummaryUpdateOne {
	mutation := newAgentSessionSummaryMutation(c.config, OpUpdateOne, withAgentSessionSummary(_m))
	return &AgentSessionSummaryUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AgentSessionSummaryClient) UpdateOneID(id int64) *AgentSessionSummaryUpdateOne {
	mutation := newAgentSessionSummaryMutation(c.config, OpUpdateOne, withAgentSessionSummaryID(id))
	return &AgentSessionSummaryUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AgentSessionSummary.
func (c *AgentSessionSummaryClient) Delete() *AgentSessionSummaryDelete {
	mutation := newAgentSessionSummaryMutation(c.config, OpDelete)
	return &AgentSessionSummaryDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *AgentSessionSummaryClient) DeleteOne(_m *AgentSessionSummary) *AgentSessionSummaryDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AgentSessionSummaryClient) DeleteOneID(id int64) *AgentSessionSummaryDeleteOne {
	builder := c.Delete().Where(agentsessionsummary.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AgentSessionSummaryDeleteOne{builder}
}

// Query returns a query builder for AgentSessionSummary.
func (c *AgentSessionSummaryClient) Query() *AgentSessionSummaryQuery {
	return &AgentSessionSummaryQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAgentSessionSummary},
		inters: c.Interceptors(),
	}
}

// Get returns a AgentSessionSummary entity by its id.
func (c *AgentSessionSummaryClient) Get(ctx context.Context, id int64) (*AgentSessionSummary, error) {
	return c.Query().Where(agentsessionsummary.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AgentSessionSummaryClient) GetX(ctx context.Context, id int64) *AgentSessionSummary {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *AgentSessionSummaryClient) Hooks() []Hook {
	return c.hooks.AgentSessionSummary
}

// Interceptors returns the client interceptors.
func (c *AgentSessionSummaryClient) Interceptors() []Interceptor {
	return c.inters.AgentSessionSummary
}

func (c *AgentSessionSummaryClient) mutate(ctx context.Context, m *AgentSessionSummaryMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AgentSessionSummaryCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&AgentSessionSummaryUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&AgentSessionSummaryUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AgentSessionSummaryDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown AgentSessionSummary mutation op: %q", m.Op())
	}
}
...
// AgentSkillFileClient is a client for the AgentSkillFile schema.
type AgentSkillFileClient struct {
	config
}

// NewAgentSkillFileClient returns a client for the AgentSkillFile from the given config.
func NewAgentSkillFileClient(c config) *AgentSkillFileClient {
	return &AgentSkillFileClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `agentskillfile.Hooks(f(g(h())))`.
func (c *AgentSkillFileClient) Use(hooks ...Hook) {
	c.hooks.AgentSkillFile = append(c.hooks.AgentSkillFile, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `agentskillfile.Intercept(f(g(h())))`.
func (c *AgentSkillFileClient) Intercept(interceptors ...Interceptor) {
	c.inters.AgentSkillFile = append(c.inters.AgentSkillFile, interceptors...)
}

// Create returns a builder for creating a AgentSkillFile entity.
func (c *AgentSkillFileClient) Create() *AgentSkillFileCreate {
	mutation := newAgentSkillFileMutation(c.config, OpCreate)
	return &AgentSkillFileCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of AgentSkillFile entities.
func (c *AgentSkillFileClient) CreateBulk(builders ...*AgentSkillFileCreate) *AgentSkillFileCreateBulk {
	return &AgentSkillFileCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *AgentSkillFileClient) MapCreateBulk(slice any, setFunc func(*AgentSkillFileCreate, int)) *AgentSkillFileCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AgentSkillFileCreateBulk{err: fmt.Errorf("calling to AgentSkillFileClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*AgentSkillFileCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for AgentSkillFile.
func (c *AgentSkillFileClient) Update() *AgentSkillFileUpdate {
	mutation := newAgentSkillFileMutation(c.config, OpUpdate)
	return &AgentSkillFileUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AgentSkillFileClient) UpdateOne(_m *AgentSkillFile) *AgentSkillFileUpdateOne {
	mutation := newAgentSkillFileMutation(c.config, OpUpdateOne, withAgentSkillFile(_m))
	return &AgentSkillFileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AgentSkillFileClient) UpdateOneID(id int64) *AgentSkillFileUpdateOne {
	mutation := newAgentSkillFileMutation(c.config, OpUpdateOne, withAgentSkillFileID(id))
	return &AgentSkillFileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AgentSkillFile.
func (c *AgentSkillFileClient) Delete() *AgentSkillFileDelete {
	mutation := newAgentSkillFileMutation(c.config, OpDelete)
	return &AgentSkillFileDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *AgentSkillFileClient) DeleteOne(_m *AgentSkillFile) *AgentSkillFileDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AgentSkillFileClient) DeleteOneID(id int64) *AgentSkillFileDeleteOne {
	builder := c.Delete().Where(agentskillfile.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AgentSkillFileDeleteOne{builder}
}

// Query returns a query builder for AgentSkillFile.
func (c *AgentSkillFileClient) Query() *AgentSkillFileQuery {
	return &AgentSkillFileQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAgentSkillFile},
		inters: c.Interceptors(),
	}
}

// Get returns a AgentSkillFile entity by its id.
func (c *AgentSkillFileClient) Get(ctx context.Context, id int64) (*AgentSkillFile, error) {
	return c.Query().Where(agentskillfile.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AgentSkillFileClient) GetX(ctx context.Context, id int64) *AgentSkillFile {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *AgentSkillFileClient) Hooks() []Hook {
	return c.hooks.AgentSkillFile
}

// Interceptors returns the client interceptors.
func (c *AgentSkillFileClient) Interceptors() []Interceptor {
	return c.inters.AgentSkillFile
}

func (c *AgentSkillFileClient) mutate(ctx context.Context, m *AgentSkillFileMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AgentSkillFileCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&AgentSkillFileUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&AgentSkillFileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AgentSkillFileDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown AgentSkillFile mutation op: %q", m.Op())
	}
}

// AgentSubagentClient is a client for the AgentSubagent schema.
type AgentSubagentClient struct {
	config
}

// NewAgentSubagentClient returns a client for the AgentSubagent from the given config.
func NewAgentSubagentClient(c config) *AgentSubagentClient {
	return &AgentSubagentClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `agentsubagent.Hooks(f(g(h())))`.
func (c *AgentSubagentClient) Use(hooks ...Hook) {
	c.hooks.AgentSubagent = append(c.hooks.AgentSubagent, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `agentsubagent.Intercept(f(g(h())))`.
func (c *AgentSubagentClient) Intercept(interceptors ...Interceptor) {
	c.inters.AgentSubagent = append(c.inters.AgentSubagent, interceptors...)
}

// Create returns a builder for creating a AgentSubagent entity.
func (c *AgentSubagentClient) Create() *AgentSubagentCreate {
	mutation := newAgentSubagentMutation(c.config, OpCreate)
	return &AgentSubagentCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of AgentSubagent entities.
func (c *AgentSubagentClient) CreateBulk(builders ...*AgentSubagentCreate) *AgentSubagentCreateBulk {
	return &AgentSubagentCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *AgentSubagentClient) MapCreateBulk(slice any, setFunc func(*AgentSubagentCreate, int)) *AgentSubagentCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AgentSubagentCreateBulk{err: fmt.Errorf("calling to AgentSubagentClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*AgentSubagentCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for AgentSubagent.
func (c *AgentSubagentClient) Update() *AgentSubagentUpdate {
	mutation := newAgentSubagentMutation(c.config, OpUpdate)
	return &AgentSubagentUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AgentSubagentClient) UpdateOne(_m *AgentSubagent) *AgentSubagentUpdateOne {
	mutation := newAgentSubagentMutation(c.config, OpUpdateOne, withAgentSubagent(_m))
	return &AgentSubagentUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AgentSubagentClient) UpdateOneID(id int64) *AgentSubagentUpdateOne {
	mutation := newAgentSubagentMutation(c.config, OpUpdateOne, withAgentSubagentID(id))
	return &AgentSubagentUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AgentSubagent.
func (c *AgentSubagentClient) Delete() *AgentSubagentDelete {
	mutation := newAgentSubagentMutation(c.config, OpDelete)
	return &AgentSubagentDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *AgentSubagentClient) DeleteOne(_m *AgentSubagent) *AgentSubagentDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AgentSubagentClient) DeleteOneID(id int64) *AgentSubagentDeleteOne {
	builder := c.Delete().Where(agentsubagent.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AgentSubagentDeleteOne{builder}
}

// Query returns a query builder for AgentSubagent.
func (c *AgentSubagentClient) Query() *AgentSubagentQuery {
	return &AgentSubagentQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAgentSubagent},
		inters: c.Interceptors(),
	}
}

// Get returns a AgentSubagent entity by its id.
func (c *AgentSubagentClient) Get(ctx context.Context, id int64) (*AgentSubagent, error) {
	return c.Query().Where(agentsubagent.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AgentSubagentClient) GetX(ctx context.Context, id int64) *AgentSubagent {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *AgentSubagentClient) Hooks() []Hook {
	return c.hooks.AgentSubagent
}

// Interceptors returns the client interceptors.
func (c *AgentSubagentClient) Interceptors() []Interceptor {
	return c.inters.AgentSubagent
}

func (c *AgentSubagentClient) mutate(ctx context.Context, m *AgentSubagentMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AgentSubagentCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&AgentSubagentUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&AgentSubagentUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AgentSubagentDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown AgentSubagent mutation op: %q", m.Op())
	}
}

// AgentSubagentTaskClient is a client for the AgentSubagentTask schema.
type AgentSubagentTaskClient struct {
	config
}

// NewAgentSubagentTaskClient returns a client for the AgentSubagentTask from the given config.
func NewAgentSubagentTaskClient(c config) *AgentSubagentTaskClient {
	return &AgentSubagentTaskClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `agentsubagenttask.Hooks(f(g(h())))`.
func (c *AgentSubagentTaskClient) Use(hooks ...Hook) {
	c.hooks.AgentSubagentTask = append(c.hooks.AgentSubagentTask, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `agentsubagenttask.Intercept(f(g(h())))`.
func (c *AgentSubagentTaskClient) Intercept(interceptors ...Interceptor) {
	c.inters.AgentSubagentTask = append(c.inters.AgentSubagentTask, interceptors...)
}

// Create returns a builder for creating a AgentSubagentTask entity.
func (c *AgentSubagentTaskClient) Create() *AgentSubagentTaskCreate {
	mutation := newAgentSubagentTaskMutation(c.config, OpCreate)
	return &AgentSubagentTaskCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of AgentSubagentTask entities.
func (c *AgentSubagentTaskClient) CreateBulk(builders ...*AgentSubagentTaskCreate) *AgentSubagentTaskCreateBulk {
	return &AgentSubagentTaskCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *AgentSubagentTaskClient) MapCreateBulk(slice any, setFunc func(*AgentSubagentTaskCreate, int)) *AgentSubagentTaskCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AgentSubagentTaskCreateBulk{err: fmt.Errorf("calling to AgentSubagentTaskClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*AgentSubagentTaskCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for AgentSubagentTask.
func (c *AgentSubagentTaskClient) Update() *AgentSubagentTaskUpdate {
	mutation := newAgentSubagentTaskMutation(c.config, OpUpdate)
	return &AgentSubagentTaskUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AgentSubagentTaskClient) UpdateOne(_m *AgentSubagentTask) *AgentSubagentTaskUpdateOne {
	mutation := newAgentSubagentTaskMutation(c.config, OpUpdateOne, withAgentSubagentTask(_m))
	return &AgentSubagentTaskUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AgentSubagentTaskClient) UpdateOneID(id int64) *AgentSubagentTaskUpdateOne {
	mutation := newAgentSubagentTaskMutation(c.config, OpUpdateOne, withAgentSubagentTaskID(id))
	return &AgentSubagentTaskUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AgentSubagentTask.
func (c *AgentSubagentTaskClient) Delete() *AgentSubagentTaskDelete {
	mutation := newAgentSubagentTaskMutation(c.config, OpDelete)
	return &AgentSubagentTaskDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *AgentSubagentTaskClient) DeleteOne(_m *AgentSubagentTask) *AgentSubagentTaskDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AgentSubagentTaskClient) DeleteOneID(id int64) *AgentSubagentTaskDeleteOne {
	builder := c.Delete().Where(agentsubagenttask.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AgentSubagentTaskDeleteOne{builder}
}

// Query returns a query builder for AgentSubagentTask.
func (c *AgentSubagentTaskClient) Query() *AgentSubagentTaskQuery {
	return &AgentSubagentTaskQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAgentSubagentTask},
		inters: c.Interceptors(),
	}
}

// Get returns a AgentSubagentTask entity by its id.
func (c *AgentSubagentTaskClient) Get(ctx context.Context, id int64) (*AgentSubagentTask, error) {
	return c.Query().Where(agentsubagenttask.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AgentSubagentTaskClient) GetX(ctx context.Context, id int64) *AgentSubagentTask {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *AgentSubagentTaskClient) Hooks() []Hook {
	return c.hooks.AgentSubagentTask
}

// Interceptors returns the client interceptors.
func (c *AgentSubagentTaskClient) Interceptors() []Interceptor {
	return c.inters.AgentSubagentTask
}

func (c *AgentSubagentTaskClient) mutate(ctx context.Context, m *AgentSubagentTaskMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AgentSubagentTaskCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&AgentSubagentTaskUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&AgentSubagentTaskUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AgentSubagentTaskDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown AgentSubagentTask mutation op: %q", m.Op())
	}
}

// AgentTodoClient is a client for the AgentTodo schema.
type AgentTodoClient struct {
	config
}

// NewAgentTodoClient returns a client for the AgentTodo from the given config.
func NewAgentTodoClient(c config) *AgentTodoClient {
	return &AgentTodoClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `agenttodo.Hooks(f(g(h())))`.
func (c *AgentTodoClient) Use(hooks ...Hook) {
	c.hooks.AgentTodo = append(c.hooks.AgentTodo, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `agenttodo.Intercept(f(g(h())))`.
func (c *AgentTodoClient) Intercept(interceptors ...Interceptor) {
	c.inters.AgentTodo = append(c.inters.AgentTodo, interceptors...)
}

// Create returns a builder for creating a AgentTodo entity.
func (c *AgentTodoClient) Create() *AgentTodoCreate {
	mutation := newAgentTodoMutation(c.config, OpCreate)
	return &AgentTodoCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of AgentTodo entities.
func (c *AgentTodoClient) CreateBulk(builders ...*AgentTodoCreate) *AgentTodoCreateBulk {
	return &AgentTodoCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *AgentTodoClient) MapCreateBulk(slice any, setFunc func(*AgentTodoCreate, int)) *AgentTodoCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AgentTodoCreateBulk{err: fmt.Errorf("calling to AgentTodoClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*AgentTodoCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for AgentTodo.
func (c *AgentTodoClient) Update() *AgentTodoUpdate {
	mutation := newAgentTodoMutation(c.config, OpUpdate)
	return &AgentTodoUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AgentTodoClient) UpdateOne(_m *AgentTodo) *AgentTodoUpdateOne {
	mutation := newAgentTodoMutation(c.config, OpUpdateOne, withAgentTodo(_m))
	return &AgentTodoUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AgentTodoClient) UpdateOneID(id int64) *AgentTodoUpdateOne {
	mutation := newAgentTodoMutation(c.config, OpUpdateOne, withAgentTodoID(id))
	return &AgentTodoUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AgentTodo.
func (c *AgentTodoClient) Delete() *AgentTodoDelete {
	mutation := newAgentTodoMutation(c.config, OpDelete)
	return &AgentTodoDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *AgentTodoClient) DeleteOne(_m *AgentTodo) *AgentTodoDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AgentTodoClient) DeleteOneID(id int64) *AgentTodoDeleteOne {
	builder := c.Delete().Where(agenttodo.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AgentTodoDeleteOne{builder}
}

// Query returns a query builder for AgentTodo.
func (c *AgentTodoClient) Query() *AgentTodoQuery {
	return &AgentTodoQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAgentTodo},
		inters: c.Interceptors(),
	}
}

// Get returns a AgentTodo entity by its id.
func (c *AgentTodoClient) Get(ctx context.Context, id int64) (*AgentTodo, error) {
	return c.Query().Where(agenttodo.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AgentTodoClient) GetX(ctx context.Context, id int64) *AgentTodo {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *AgentTodoClient) Hooks() []Hook {
	return c.hooks.AgentTodo
}

// Interceptors returns the client interceptors.
func (c *AgentTodoClient) Interceptors() []Interceptor {
	return c.inters.AgentTodo
}

func (c *AgentTodoClient) mutate(ctx context.Context, m *AgentTodoMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AgentTodoCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&AgentTodoUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&AgentTodoUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AgentTodoDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown AgentTodo mutation op: %q", m.Op())
	}
}
...
// LifeAIContextClient is a client for the LifeAIContext schema.
type LifeAIContextClient struct {
	config
}

// NewLifeAIContextClient returns a client for the LifeAIContext from the given config.
func NewLifeAIContextClient(c config) *LifeAIContextClient {
	return &LifeAIContextClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeaicontext.Hooks(f(g(h())))`.
func (c *LifeAIContextClient) Use(hooks ...Hook) {
	c.hooks.LifeAIContext = append(c.hooks.LifeAIContext, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeaicontext.Intercept(f(g(h())))`.
func (c *LifeAIContextClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeAIContext = append(c.inters.LifeAIContext, interceptors...)
}

// Create returns a builder for creating a LifeAIContext entity.
func (c *LifeAIContextClient) Create() *LifeAIContextCreate {
	mutation := newLifeAIContextMutation(c.config, OpCreate)
	return &LifeAIContextCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeAIContext entities.
func (c *LifeAIContextClient) CreateBulk(builders ...*LifeAIContextCreate) *LifeAIContextCreateBulk {
	return &LifeAIContextCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeAIContextClient) MapCreateBulk(slice any, setFunc func(*LifeAIContextCreate, int)) *LifeAIContextCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeAIContextCreateBulk{err: fmt.Errorf("calling to LifeAIContextClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeAIContextCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeAIContext.
func (c *LifeAIContextClient) Update() *LifeAIContextUpdate {
	mutation := newLifeAIContextMutation(c.config, OpUpdate)
	return &LifeAIContextUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeAIContextClient) UpdateOne(_m *LifeAIContext) *LifeAIContextUpdateOne {
	mutation := newLifeAIContextMutation(c.config, OpUpdateOne, withLifeAIContext(_m))
	return &LifeAIContextUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeAIContextClient) UpdateOneID(id int64) *LifeAIContextUpdateOne {
	mutation := newLifeAIContextMutation(c.config, OpUpdateOne, withLifeAIContextID(id))
	return &LifeAIContextUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeAIContext.
func (c *LifeAIContextClient) Delete() *LifeAIContextDelete {
	mutation := newLifeAIContextMutation(c.config, OpDelete)
	return &LifeAIContextDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeAIContextClient) DeleteOne(_m *LifeAIContext) *LifeAIContextDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeAIContextClient) DeleteOneID(id int64) *LifeAIContextDeleteOne {
	builder := c.Delete().Where(lifeaicontext.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeAIContextDeleteOne{builder}
}

// Query returns a query builder for LifeAIContext.
func (c *LifeAIContextClient) Query() *LifeAIContextQuery {
	return &LifeAIContextQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeAIContext},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeAIContext entity by its id.
func (c *LifeAIContextClient) Get(ctx context.Context, id int64) (*LifeAIContext, error) {
	return c.Query().Where(lifeaicontext.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeAIContextClient) GetX(ctx context.Context, id int64) *LifeAIContext {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeAIContextClient) Hooks() []Hook {
	return c.hooks.LifeAIContext
}

// Interceptors returns the client interceptors.
func (c *LifeAIContextClient) Interceptors() []Interceptor {
	return c.inters.LifeAIContext
}

func (c *LifeAIContextClient) mutate(ctx context.Context, m *LifeAIContextMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeAIContextCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeAIContextUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeAIContextUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
...
// LifeActionLogClient is a client for the LifeActionLog schema.
type LifeActionLogClient struct {
	config
}

// NewLifeActionLogClient returns a client for the LifeActionLog from the given config.
func NewLifeActionLogClient(c config) *LifeActionLogClient {
	return &LifeActionLogClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeactionlog.Hooks(f(g(h())))`.
func (c *LifeActionLogClient) Use(hooks ...Hook) {
	c.hooks.LifeActionLog = append(c.hooks.LifeActionLog, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeactionlog.Intercept(f(g(h())))`.
func (c *LifeActionLogClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeActionLog = append(c.inters.LifeActionLog, interceptors...)
}

// Create returns a builder for creating a LifeActionLog entity.
func (c *LifeActionLogClient) Create() *LifeActionLogCreate {
	mutation := newLifeActionLogMutation(c.config, OpCreate)
	return &LifeActionLogCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeActionLog entities.
func (c *LifeActionLogClient) CreateBulk(builders ...*LifeActionLogCreate) *LifeActionLogCreateBulk {
	return &LifeActionLogCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeActionLogClient) MapCreateBulk(slice any, setFunc func(*LifeActionLogCreate, int)) *LifeActionLogCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeActionLogCreateBulk{err: fmt.Errorf("calling to LifeActionLogClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeActionLogCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeActionLog.
func (c *LifeActionLogClient) Update() *LifeActionLogUpdate {
	mutation := newLifeActionLogMutation(c.config, OpUpdate)
	return &LifeActionLogUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeActionLogClient) UpdateOne(_m *LifeActionLog) *LifeActionLogUpdateOne {
	mutation := newLifeActionLogMutation(c.config, OpUpdateOne, withLifeActionLog(_m))
	return &LifeActionLogUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeActionLogClient) UpdateOneID(id int64) *LifeActionLogUpdateOne {
	mutation := newLifeActionLogMutation(c.config, OpUpdateOne, withLifeActionLogID(id))
	return &LifeActionLogUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeActionLog.
func (c *LifeActionLogClient) Delete() *LifeActionLogDelete {
	mutation := newLifeActionLogMutation(c.config, OpDelete)
	return &LifeActionLogDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeActionLogClient) DeleteOne(_m *LifeActionLog) *LifeActionLogDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeActionLogClient) DeleteOneID(id int64) *LifeActionLogDeleteOne {
	builder := c.Delete().Where(lifeactionlog.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeActionLogDeleteOne{builder}
}

// Query returns a query builder for LifeActionLog.
func (c *LifeActionLogClient) Query() *LifeActionLogQuery {
	return &LifeActionLogQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeActionLog},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeActionLog entity by its id.
func (c *LifeActionLogClient) Get(ctx context.Context, id int64) (*LifeActionLog, error) {
	return c.Query().Where(lifeactionlog.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeActionLogClient) GetX(ctx context.Context, id int64) *LifeActionLog {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeActionLogClient) Hooks() []Hook {
	return c.hooks.LifeActionLog
}

// Interceptors returns the client interceptors.
func (c *LifeActionLogClient) Interceptors() []Interceptor {
	return c.inters.LifeActionLog
}

func (c *LifeActionLogClient) mutate(ctx context.Context, m *LifeActionLogMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeActionLogCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeActionLogUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeActionLogUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeActionLogDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeActionLog mutation op: %q", m.Op())
	}
}

// LifeActionOccurrenceClient is a client for the LifeActionOccurrence schema.
type LifeActionOccurrenceClient struct {
	config
}

// NewLifeActionOccurrenceClient returns a client for the LifeActionOccurrence from the given config.
func NewLifeActionOccurrenceClient(c config) *LifeActionOccurrenceClient {
	return &LifeActionOccurrenceClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeactionoccurrence.Hooks(f(g(h())))`.
func (c *LifeActionOccurrenceClient) Use(hooks ...Hook) {
	c.hooks.LifeActionOccurrence = append(c.hooks.LifeActionOccurrence, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeactionoccurrence.Intercept(f(g(h())))`.
func (c *LifeActionOccurrenceClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeActionOccurrence = append(c.inters.LifeActionOccurrence, interceptors...)
}

// Create returns a builder for creating a LifeActionOccurrence entity.
func (c *LifeActionOccurrenceClient) Create() *LifeActionOccurrenceCreate {
	mutation := newLifeActionOccurrenceMutation(c.config, OpCreate)
	return &LifeActionOccurrenceCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeActionOccurrence entities.
func (c *LifeActionOccurrenceClient) CreateBulk(builders ...*LifeActionOccurrenceCreate) *LifeActionOccurrenceCreateBulk {
	return &LifeActionOccurrenceCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeActionOccurrenceClient) MapCreateBulk(slice any, setFunc func(*LifeActionOccurrenceCreate, int)) *LifeActionOccurrenceCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeActionOccurrenceCreateBulk{err: fmt.Errorf("calling to LifeActionOccurrenceClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeActionOccurrenceCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeActionOccurrence.
func (c *LifeActionOccurrenceClient) Update() *LifeActionOccurrenceUpdate {
	mutation := newLifeActionOccurrenceMutation(c.config, OpUpdate)
	return &LifeActionOccurrenceUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeActionOccurrenceClient) UpdateOne(_m *LifeActionOccurrence) *LifeActionOccurrenceUpdateOne {
	mutation := newLifeActionOccurrenceMutation(c.config, OpUpdateOne, withLifeActionOccurrence(_m))
	return &LifeActionOccurrenceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeActionOccurrenceClient) UpdateOneID(id int64) *LifeActionOccurrenceUpdateOne {
	mutation := newLifeActionOccurrenceMutation(c.config, OpUpdateOne, withLifeActionOccurrenceID(id))
	return &LifeActionOccurrenceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeActionOccurrence.
func (c *LifeActionOccurrenceClient) Delete() *LifeActionOccurrenceDelete {
	mutation := newLifeActionOccurrenceMutation(c.config, OpDelete)
	return &LifeActionOccurrenceDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeActionOccurrenceClient) DeleteOne(_m *LifeActionOccurrence) *LifeActionOccurrenceDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeActionOccurrenceClient) DeleteOneID(id int64) *LifeActionOccurrenceDeleteOne {
	builder := c.Delete().Where(lifeactionoccurrence.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeActionOccurrenceDeleteOne{builder}
}

// Query returns a query builder for LifeActionOccurrence.
func (c *LifeActionOccurrenceClient) Query() *LifeActionOccurrenceQuery {
	return &LifeActionOccurrenceQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeActionOccurrence},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeActionOccurrence entity by its id.
func (c *LifeActionOccurrenceClient) Get(ctx context.Context, id int64) (*LifeActionOccurrence, error) {
	return c.Query().Where(lifeactionoccurrence.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeActionOccurrenceClient) GetX(ctx context.Context, id int64) *LifeActionOccurrence {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeActionOccurrenceClient) Hooks() []Hook {
	return c.hooks.LifeActionOccurrence
}

// Interceptors returns the client interceptors.
func (c *LifeActionOccurrenceClient) Interceptors() []Interceptor {
	return c.inters.LifeActionOccurrence
}

func (c *LifeActionOccurrenceClient) mutate(ctx context.Context, m *LifeActionOccurrenceMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeActionOccurrenceCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeActionOccurrenceUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeActionOccurrenceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeActionOccurrenceDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeActionOccurrence mutation op: %q", m.Op())
	}
}

// LifeActionSpecClient is a client for the LifeActionSpec schema.
type LifeActionSpecClient struct {
	config
}

// NewLifeActionSpecClient returns a client for the LifeActionSpec from the given config.
func NewLifeActionSpecClient(c config) *LifeActionSpecClient {
	return &LifeActionSpecClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeactionspec.Hooks(f(g(h())))`.
func (c *LifeActionSpecClient) Use(hooks ...Hook) {
	c.hooks.LifeActionSpec = append(c.hooks.LifeActionSpec, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeactionspec.Intercept(f(g(h())))`.
func (c *LifeActionSpecClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeActionSpec = append(c.inters.LifeActionSpec, interceptors...)
}

// Create returns a builder for creating a LifeActionSpec entity.
func (c *LifeActionSpecClient) Create() *LifeActionSpecCreate {
	mutation := newLifeActionSpecMutation(c.config, OpCreate)
	return &LifeActionSpecCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeActionSpec entities.
func (c *LifeActionSpecClient) CreateBulk(builders ...*LifeActionSpecCreate) *LifeActionSpecCreateBulk {
	return &LifeActionSpecCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeActionSpecClient) MapCreateBulk(slice any, setFunc func(*LifeActionSpecCreate, int)) *LifeActionSpecCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeActionSpecCreateBulk{err: fmt.Errorf("calling to LifeActionSpecClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeActionSpecCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeActionSpec.
func (c *LifeActionSpecClient) Update() *LifeActionSpecUpdate {
	mutation := newLifeActionSpecMutation(c.config, OpUpdate)
	return &LifeActionSpecUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeActionSpecClient) UpdateOne(_m *LifeActionSpec) *LifeActionSpecUpdateOne {
	mutation := newLifeActionSpecMutation(c.config, OpUpdateOne, withLifeActionSpec(_m))
	return &LifeActionSpecUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeActionSpecClient) UpdateOneID(id int64) *LifeActionSpecUpdateOne {
	mutation := newLifeActionSpecMutation(c.config, OpUpdateOne, withLifeActionSpecID(id))
	return &LifeActionSpecUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeActionSpec.
func (c *LifeActionSpecClient) Delete() *LifeActionSpecDelete {
	mutation := newLifeActionSpecMutation(c.config, OpDelete)
	return &LifeActionSpecDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeActionSpecClient) DeleteOne(_m *LifeActionSpec) *LifeActionSpecDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeActionSpecClient) DeleteOneID(id int64) *LifeActionSpecDeleteOne {
	builder := c.Delete().Where(lifeactionspec.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeActionSpecDeleteOne{builder}
}

// Query returns a query builder for LifeActionSpec.
func (c *LifeActionSpecClient) Query() *LifeActionSpecQuery {
	return &LifeActionSpecQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeActionSpec},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeActionSpec entity by its id.
func (c *LifeActionSpecClient) Get(ctx context.Context, id int64) (*LifeActionSpec, error) {
	return c.Query().Where(lifeactionspec.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeActionSpecClient) GetX(ctx context.Context, id int64) *LifeActionSpec {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeActionSpecClient) Hooks() []Hook {
	return c.hooks.LifeActionSpec
}

// Interceptors returns the client interceptors.
func (c *LifeActionSpecClient) Interceptors() []Interceptor {
	return c.inters.LifeActionSpec
}

func (c *LifeActionSpecClient) mutate(ctx context.Context, m *LifeActionSpecMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeActionSpecCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeActionSpecUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeActionSpecUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeActionSpecDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeActionSpec mutation op: %q", m.Op())
	}
}
...
// NewLifeCharacteristicClient returns a client for the LifeCharacteristic from the given config.
func NewLifeCharacteristicClient(c config) *LifeCharacteristicClient {
	return &LifeCharacteristicClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifecharacteristic.Hooks(f(g(h())))`.
func (c *LifeCharacteristicClient) Use(hooks ...Hook) {
	c.hooks.LifeCharacteristic = append(c.hooks.LifeCharacteristic, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifecharacteristic.Intercept(f(g(h())))`.
func (c *LifeCharacteristicClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeCharacteristic = append(c.inters.LifeCharacteristic, interceptors...)
}

// Create returns a builder for creating a LifeCharacteristic entity.
func (c *LifeCharacteristicClient) Create() *LifeCharacteristicCreate {
	mutation := newLifeCharacteristicMutation(c.config, OpCreate)
	return &LifeCharacteristicCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeCharacteristic entities.
func (c *LifeCharacteristicClient) CreateBulk(builders ...*LifeCharacteristicCreate) *LifeCharacteristicCreateBulk {
	return &LifeCharacteristicCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeCharacteristicClient) MapCreateBulk(slice any, setFunc func(*LifeCharacteristicCreate, int)) *LifeCharacteristicCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeCharacteristicCreateBulk{err: fmt.Errorf("calling to LifeCharacteristicClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeCharacteristicCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeCharacteristic.
func (c *LifeCharacteristicClient) Update() *LifeCharacteristicUpdate {
	mutation := newLifeCharacteristicMutation(c.config, OpUpdate)
	return &LifeCharacteristicUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeCharacteristicClient) UpdateOne(_m *LifeCharacteristic) *LifeCharacteristicUpdateOne {
	mutation := newLifeCharacteristicMutation(c.config, OpUpdateOne, withLifeCharacteristic(_m))
	return &LifeCharacteristicUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeCharacteristicClient) UpdateOneID(id int64) *LifeCharacteristicUpdateOne {
	mutation := newLifeCharacteristicMutation(c.config, OpUpdateOne, withLifeCharacteristicID(id))
	return &LifeCharacteristicUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeCharacteristic.
func (c *LifeCharacteristicClient) Delete() *LifeCharacteristicDelete {
	mutation := newLifeCharacteristicMutation(c.config, OpDelete)
	return &LifeCharacteristicDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeCharacteristicClient) DeleteOne(_m *LifeCharacteristic) *LifeCharacteristicDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeCharacteristicClient) DeleteOneID(id int64) *LifeCharacteristicDeleteOne {
	builder := c.Delete().Where(lifecharacteristic.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeCharacteristicDeleteOne{builder}
}

// Query returns a query builder for LifeCharacteristic.
func (c *LifeCharacteristicClient) Query() *LifeCharacteristicQuery {
	return &LifeCharacteristicQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeCharacteristic},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeCharacteristic entity by its id.
func (c *LifeCharacteristicClient) Get(ctx context.Context, id int64) (*LifeCharacteristic, error) {
	return c.Query().Where(lifecharacteristic.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeCharacteristicClient) GetX(ctx context.Context, id int64) *LifeCharacteristic {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeCharacteristicClient) Hooks() []Hook {
	return c.hooks.LifeCharacteristic
}

// Interceptors returns the client interceptors.
func (c *LifeCharacteristicClient) Interceptors() []Interceptor {
	return c.inters.LifeCharacteristic
}

func (c *LifeCharacteristicClient) mutate(ctx context.Context, m *LifeCharacteristicMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeCharacteristicCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeCharacteristicUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeCharacteristicUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeCharacteristicDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeCharacteristic mutation op: %q", m.Op())
	}
}

// LifeEquipmentClient is a client for the LifeEquipment schema.
type LifeEquipmentClient struct {
	config
}

// NewLifeEquipmentClient returns a client for the LifeEquipment from the given config.
func NewLifeEquipmentClient(c config) *LifeEquipmentClient {
	return &LifeEquipmentClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeequipment.Hooks(f(g(h())))`.
func (c *LifeEquipmentClient) Use(hooks ...Hook) {
	c.hooks.LifeEquipment = append(c.hooks.LifeEquipment, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeequipment.Intercept(f(g(h())))`.
func (c *LifeEquipmentClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeEquipment = append(c.inters.LifeEquipment, interceptors...)
}

// Create returns a builder for creating a LifeEquipment entity.
func (c *LifeEquipmentClient) Create() *LifeEquipmentCreate {
	mutation := newLifeEquipmentMutation(c.config, OpCreate)
	return &LifeEquipmentCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeEquipment entities.
func (c *LifeEquipmentClient) CreateBulk(builders ...*LifeEquipmentCreate) *LifeEquipmentCreateBulk {
	return &LifeEquipmentCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeEquipmentClient) MapCreateBulk(slice any, setFunc func(*LifeEquipmentCreate, int)) *LifeEquipmentCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeEquipmentCreateBulk{err: fmt.Errorf("calling to LifeEquipmentClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeEquipmentCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeEquipment.
func (c *LifeEquipmentClient) Update() *LifeEquipmentUpdate {
	mutation := newLifeEquipmentMutation(c.config, OpUpdate)
	return &LifeEquipmentUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeEquipmentClient) UpdateOne(_m *LifeEquipment) *LifeEquipmentUpdateOne {
	mutation := newLifeEquipmentMutation(c.config, OpUpdateOne, withLifeEquipment(_m))
	return &LifeEquipmentUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeEquipmentClient) UpdateOneID(id int64) *LifeEquipmentUpdateOne {
	mutation := newLifeEquipmentMutation(c.config, OpUpdateOne, withLifeEquipmentID(id))
	return &LifeEquipmentUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeEquipment.
func (c *LifeEquipmentClient) Delete() *LifeEquipmentDelete {
	mutation := newLifeEquipmentMutation(c.config, OpDelete)
	return &LifeEquipmentDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeEquipmentClient) DeleteOne(_m *LifeEquipment) *LifeEquipmentDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeEquipmentClient) DeleteOneID(id int64) *LifeEquipmentDeleteOne {
	builder := c.Delete().Where(lifeequipment.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeEquipmentDeleteOne{builder}
}

// Query returns a query builder for LifeEquipment.
func (c *LifeEquipmentClient) Query() *LifeEquipmentQuery {
	return &LifeEquipmentQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeEquipment},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeEquipment entity by its id.
func (c *LifeEquipmentClient) Get(ctx context.Context, id int64) (*LifeEquipment, error) {
	return c.Query().Where(lifeequipment.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeEquipmentClient) GetX(ctx context.Context, id int64) *LifeEquipment {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeEquipmentClient) Hooks() []Hook {
	return c.hooks.LifeEquipment
}

// Interceptors returns the client interceptors.
func (c *LifeEquipmentClient) Interceptors() []Interceptor {
	return c.inters.LifeEquipment
}

func (c *LifeEquipmentClient) mutate(ctx context.Context, m *LifeEquipmentMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeEquipmentCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeEquipmentUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeEquipmentUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeEquipmentDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeEquipment mutation op: %q", m.Op())
	}
}

// LifeEquippedSlotsClient is a client for the LifeEquippedSlots schema.
type LifeEquippedSlotsClient struct {
	config
}

// NewLifeEquippedSlotsClient returns a client for the LifeEquippedSlots from the given config.
func NewLifeEquippedSlotsClient(c config) *LifeEquippedSlotsClient {
	return &LifeEquippedSlotsClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeequippedslots.Hooks(f(g(h())))`.
func (c *LifeEquippedSlotsClient) Use(hooks ...Hook) {
	c.hooks.LifeEquippedSlots = append(c.hooks.LifeEquippedSlots, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeequippedslots.Intercept(f(g(h())))`.
func (c *LifeEquippedSlotsClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeEquippedSlots = append(c.inters.LifeEquippedSlots, interceptors...)
}

// Create returns a builder for creating a LifeEquippedSlots entity.
func (c *LifeEquippedSlotsClient) Create() *LifeEquippedSlotsCreate {
	mutation := newLifeEquippedSlotsMutation(c.config, OpCreate)
	return &LifeEquippedSlotsCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeEquippedSlots entities.
func (c *LifeEquippedSlotsClient) CreateBulk(builders ...*LifeEquippedSlotsCreate) *LifeEquippedSlotsCreateBulk {
	return &LifeEquippedSlotsCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeEquippedSlotsClient) MapCreateBulk(slice any, setFunc func(*LifeEquippedSlotsCreate, int)) *LifeEquippedSlotsCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeEquippedSlotsCreateBulk{err: fmt.Errorf("calling to LifeEquippedSlotsClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeEquippedSlotsCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeEquippedSlots.
func (c *LifeEquippedSlotsClient) Update() *LifeEquippedSlotsUpdate {
	mutation := newLifeEquippedSlotsMutation(c.config, OpUpdate)
	return &LifeEquippedSlotsUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeEquippedSlotsClient) UpdateOne(_m *LifeEquippedSlots) *LifeEquippedSlotsUpdateOne {
	mutation := newLifeEquippedSlotsMutation(c.config, OpUpdateOne, withLifeEquippedSlots(_m))
	return &LifeEquippedSlotsUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeEquippedSlotsClient) UpdateOneID(id int64) *LifeEquippedSlotsUpdateOne {
	mutation := newLifeEquippedSlotsMutation(c.config, OpUpdateOne, withLifeEquippedSlotsID(id))
	return &LifeEquippedSlotsUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeEquippedSlots.
func (c *LifeEquippedSlotsClient) Delete() *LifeEquippedSlotsDelete {
	mutation := newLifeEquippedSlotsMutation(c.config, OpDelete)
	return &LifeEquippedSlotsDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeEquippedSlotsClient) DeleteOne(_m *LifeEquippedSlots) *LifeEquippedSlotsDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeEquippedSlotsClient) DeleteOneID(id int64) *LifeEquippedSlotsDeleteOne {
	builder := c.Delete().Where(lifeequippedslots.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeEquippedSlotsDeleteOne{builder}
}

// Query returns a query builder for LifeEquippedSlots.
func (c *LifeEquippedSlotsClient) Query() *LifeEquippedSlotsQuery {
	return &LifeEquippedSlotsQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeEquippedSlots},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeEquippedSlots entity by its id.
func (c *LifeEquippedSlotsClient) Get(ctx context.Context, id int64) (*LifeEquippedSlots, error) {
	return c.Query().Where(lifeequippedslots.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeEquippedSlotsClient) GetX(ctx context.Context, id int64) *LifeEquippedSlots {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeEquippedSlotsClient) Hooks() []Hook {
	return c.hooks.LifeEquippedSlots
}

// Interceptors returns the client interceptors.
func (c *LifeEquippedSlotsClient) Interceptors() []Interceptor {
	return c.inters.LifeEquippedSlots
}

func (c *LifeEquippedSlotsClient) mutate(ctx context.Context, m *LifeEquippedSlotsMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeEquippedSlotsCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeEquippedSlotsUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeEquippedSlotsUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
...
// LifeGoalClient is a client for the LifeGoal schema.
type LifeGoalClient struct {
	config
}

// NewLifeGoalClient returns a client for the LifeGoal from the given config.
func NewLifeGoalClient(c config) *LifeGoalClient {
	return &LifeGoalClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifegoal.Hooks(f(g(h())))`.
func (c *LifeGoalClient) Use(hooks ...Hook) {
	c.hooks.LifeGoal = append(c.hooks.LifeGoal, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifegoal.Intercept(f(g(h())))`.
func (c *LifeGoalClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeGoal = append(c.inters.LifeGoal, interceptors...)
}

// Create returns a builder for creating a LifeGoal entity.
func (c *LifeGoalClient) Create() *LifeGoalCreate {
	mutation := newLifeGoalMutation(c.config, OpCreate)
	return &LifeGoalCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeGoal entities.
func (c *LifeGoalClient) CreateBulk(builders ...*LifeGoalCreate) *LifeGoalCreateBulk {
	return &LifeGoalCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeGoalClient) MapCreateBulk(slice any, setFunc func(*LifeGoalCreate, int)) *LifeGoalCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeGoalCreateBulk{err: fmt.Errorf("calling to LifeGoalClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeGoalCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeGoal.
func (c *LifeGoalClient) Update() *LifeGoalUpdate {
	mutation := newLifeGoalMutation(c.config, OpUpdate)
	return &LifeGoalUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeGoalClient) UpdateOne(_m *LifeGoal) *LifeGoalUpdateOne {
	mutation := newLifeGoalMutation(c.config, OpUpdateOne, withLifeGoal(_m))
	return &LifeGoalUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeGoalClient) UpdateOneID(id int64) *LifeGoalUpdateOne {
	mutation := newLifeGoalMutation(c.config, OpUpdateOne, withLifeGoalID(id))
	return &LifeGoalUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeGoal.
func (c *LifeGoalClient) Delete() *LifeGoalDelete {
	mutation := newLifeGoalMutation(c.config, OpDelete)
	return &LifeGoalDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeGoalClient) DeleteOne(_m *LifeGoal) *LifeGoalDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeGoalClient) DeleteOneID(id int64) *LifeGoalDeleteOne {
	builder := c.Delete().Where(lifegoal.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeGoalDeleteOne{builder}
}

// Query returns a query builder for LifeGoal.
func (c *LifeGoalClient) Query() *LifeGoalQuery {
	return &LifeGoalQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeGoal},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeGoal entity by its id.
func (c *LifeGoalClient) Get(ctx context.Context, id int64) (*LifeGoal, error) {
	return c.Query().Where(lifegoal.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeGoalClient) GetX(ctx context.Context, id int64) *LifeGoal {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeGoalClient) Hooks() []Hook {
	return c.hooks.LifeGoal
}

// Interceptors returns the client interceptors.
func (c *LifeGoalClient) Interceptors() []Interceptor {
	return c.inters.LifeGoal
}

func (c *LifeGoalClient) mutate(ctx context.Context, m *LifeGoalMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeGoalCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeGoalUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeGoalUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeGoalDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeGoal mutation op: %q", m.Op())
	}
}

// LifeHabitCheckinClient is a client for the LifeHabitCheckin schema.
type LifeHabitCheckinClient struct {
	config
}

// NewLifeHabitCheckinClient returns a client for the LifeHabitCheckin from the given config.
func NewLifeHabitCheckinClient(c config) *LifeHabitCheckinClient {
	return &LifeHabitCheckinClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifehabitcheckin.Hooks(f(g(h())))`.
func (c *LifeHabitCheckinClient) Use(hooks ...Hook) {
	c.hooks.LifeHabitCheckin = append(c.hooks.LifeHabitCheckin, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifehabitcheckin.Intercept(f(g(h())))`.
func (c *LifeHabitCheckinClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeHabitCheckin = append(c.inters.LifeHabitCheckin, interceptors...)
}

// Create returns a builder for creating a LifeHabitCheckin entity.
func (c *LifeHabitCheckinClient) Create() *LifeHabitCheckinCreate {
	mutation := newLifeHabitCheckinMutation(c.config, OpCreate)
	return &LifeHabitCheckinCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeHabitCheckin entities.
func (c *LifeHabitCheckinClient) CreateBulk(builders ...*LifeHabitCheckinCreate) *LifeHabitCheckinCreateBulk {
	return &LifeHabitCheckinCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeHabitCheckinClient) MapCreateBulk(slice any, setFunc func(*LifeHabitCheckinCreate, int)) *LifeHabitCheckinCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeHabitCheckinCreateBulk{err: fmt.Errorf("calling to LifeHabitCheckinClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeHabitCheckinCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeHabitCheckin.
func (c *LifeHabitCheckinClient) Update() *LifeHabitCheckinUpdate {
	mutation := newLifeHabitCheckinMutation(c.config, OpUpdate)
	return &LifeHabitCheckinUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeHabitCheckinClient) UpdateOne(_m *LifeHabitCheckin) *LifeHabitCheckinUpdateOne {
	mutation := newLifeHabitCheckinMutation(c.config, OpUpdateOne, withLifeHabitCheckin(_m))
	return &LifeHabitCheckinUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeHabitCheckinClient) UpdateOneID(id int64) *LifeHabitCheckinUpdateOne {
	mutation := newLifeHabitCheckinMutation(c.config, OpUpdateOne, withLifeHabitCheckinID(id))
	return &LifeHabitCheckinUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeHabitCheckin.
func (c *LifeHabitCheckinClient) Delete() *LifeHabitCheckinDelete {
	mutation := newLifeHabitCheckinMutation(c.config, OpDelete)
	return &LifeHabitCheckinDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeHabitCheckinClient) DeleteOne(_m *LifeHabitCheckin) *LifeHabitCheckinDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeHabitCheckinClient) DeleteOneID(id int64) *LifeHabitCheckinDeleteOne {
	builder := c.Delete().Where(lifehabitcheckin.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeHabitCheckinDeleteOne{builder}
}

// Query returns a query builder for LifeHabitCheckin.
func (c *LifeHabitCheckinClient) Query() *LifeHabitCheckinQuery {
	return &LifeHabitCheckinQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeHabitCheckin},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeHabitCheckin entity by its id.
func (c *LifeHabitCheckinClient) Get(ctx context.Context, id int64) (*LifeHabitCheckin, error) {
	return c.Query().Where(lifehabitcheckin.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeHabitCheckinClient) GetX(ctx context.Context, id int64) *LifeHabitCheckin {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeHabitCheckinClient) Hooks() []Hook {
	return c.hooks.LifeHabitCheckin
}

// Interceptors returns the client interceptors.
func (c *LifeHabitCheckinClient) Interceptors() []Interceptor {
	return c.inters.LifeHabitCheckin
}

func (c *LifeHabitCheckinClient) mutate(ctx context.Context, m *LifeHabitCheckinMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeHabitCheckinCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeHabitCheckinUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeHabitCheckinUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeHabitCheckinDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeHabitCheckin mutation op: %q", m.Op())
	}
}

// LifeInventoryClient is a client for the LifeInventory schema.
type LifeInventoryClient struct {
	config
}

// NewLifeInventoryClient returns a client for the LifeInventory from the given config.
func NewLifeInventoryClient(c config) *LifeInventoryClient {
	return &LifeInventoryClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeinventory.Hooks(f(g(h())))`.
func (c *LifeInventoryClient) Use(hooks ...Hook) {
	c.hooks.LifeInventory = append(c.hooks.LifeInventory, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeinventory.Intercept(f(g(h())))`.
func (c *LifeInventoryClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeInventory = append(c.inters.LifeInventory, interceptors...)
}

// Create returns a builder for creating a LifeInventory entity.
func (c *LifeInventoryClient) Create() *LifeInventoryCreate {
	mutation := newLifeInventoryMutation(c.config, OpCreate)
	return &LifeInventoryCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeInventory entities.
func (c *LifeInventoryClient) CreateBulk(builders ...*LifeInventoryCreate) *LifeInventoryCreateBulk {
	return &LifeInventoryCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeInventoryClient) MapCreateBulk(slice any, setFunc func(*LifeInventoryCreate, int)) *LifeInventoryCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeInventoryCreateBulk{err: fmt.Errorf("calling to LifeInventoryClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeInventoryCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeInventory.
func (c *LifeInventoryClient) Update() *LifeInventoryUpdate {
	mutation := newLifeInventoryMutation(c.config, OpUpdate)
	return &LifeInventoryUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeInventoryClient) UpdateOne(_m *LifeInventory) *LifeInventoryUpdateOne {
	mutation := newLifeInventoryMutation(c.config, OpUpdateOne, withLifeInventory(_m))
	return &LifeInventoryUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeInventoryClient) UpdateOneID(id int64) *LifeInventoryUpdateOne {
	mutation := newLifeInventoryMutation(c.config, OpUpdateOne, withLifeInventoryID(id))
	return &LifeInventoryUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeInventory.
func (c *LifeInventoryClient) Delete() *LifeInventoryDelete {
	mutation := newLifeInventoryMutation(c.config, OpDelete)
	return &LifeInventoryDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeInventoryClient) DeleteOne(_m *LifeInventory) *LifeInventoryDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeInventoryClient) DeleteOneID(id int64) *LifeInventoryDeleteOne {
	builder := c.Delete().Where(lifeinventory.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeInventoryDeleteOne{builder}
}

// Query returns a query builder for LifeInventory.
func (c *LifeInventoryClient) Query() *LifeInventoryQuery {
	return &LifeInventoryQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeInventory},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeInventory entity by its id.
func (c *LifeInventoryClient) Get(ctx context.Context, id int64) (*LifeInventory, error) {
	return c.Query().Where(lifeinventory.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeInventoryClient) GetX(ctx context.Context, id int64) *LifeInventory {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeInventoryClient) Hooks() []Hook {
	return c.hooks.LifeInventory
}

// Interceptors returns the client interceptors.
func (c *LifeInventoryClient) Interceptors() []Interceptor {
	return c.inters.LifeInventory
}

func (c *LifeInventoryClient) mutate(ctx context.Context, m *LifeInventoryMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeInventoryCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeInventoryUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeInventoryUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeInventoryDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeInventory mutation op: %q", m.Op())
	}
}

// LifeLootTableClient is a client for the LifeLootTable schema.
type LifeLootTableClient struct {
	config
}

// NewLifeLootTableClient returns a client for the LifeLootTable from the given config.
func NewLifeLootTableClient(c config) *LifeLootTableClient {
	return &LifeLootTableClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeloottable.Hooks(f(g(h())))`.
func (c *LifeLootTableClient) Use(hooks ...Hook) {
	c.hooks.LifeLootTable = append(c.hooks.LifeLootTable, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeloottable.Intercept(f(g(h())))`.
func (c *LifeLootTableClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeLootTable = append(c.inters.LifeLootTable, interceptors...)
}

// Create returns a builder for creating a LifeLootTable entity.
func (c *LifeLootTableClient) Create() *LifeLootTableCreate {
	mutation := newLifeLootTableMutation(c.config, OpCreate)
	return &LifeLootTableCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeLootTable entities.
func (c *LifeLootTableClient) CreateBulk(builders ...*LifeLootTableCreate) *LifeLootTableCreateBulk {
	return &LifeLootTableCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeLootTableClient) MapCreateBulk(slice any, setFunc func(*LifeLootTableCreate, int)) *LifeLootTableCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeLootTableCreateBulk{err: fmt.Errorf("calling to LifeLootTableClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeLootTableCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeLootTable.
func (c *LifeLootTableClient) Update() *LifeLootTableUpdate {
	mutation := newLifeLootTableMutation(c.config, OpUpdate)
	return &LifeLootTableUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeLootTableClient) UpdateOne(_m *LifeLootTable) *LifeLootTableUpdateOne {
	mutation := newLifeLootTableMutation(c.config, OpUpdateOne, withLifeLootTable(_m))
	return &LifeLootTableUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeLootTableClient) UpdateOneID(id int64) *LifeLootTableUpdateOne {
	mutation := newLifeLootTableMutation(c.config, OpUpdateOne, withLifeLootTableID(id))
	return &LifeLootTableUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeLootTable.
func (c *LifeLootTableClient) Delete() *LifeLootTableDelete {
	mutation := newLifeLootTableMutation(c.config, OpDelete)
	return &LifeLootTableDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeLootTableClient) DeleteOne(_m *LifeLootTable) *LifeLootTableDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeLootTableClient) DeleteOneID(id int64) *LifeLootTableDeleteOne {
	builder := c.Delete().Where(lifeloottable.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeLootTableDeleteOne{builder}
}

// Query returns a query builder for LifeLootTable.
func (c *LifeLootTableClient) Query() *LifeLootTableQuery {
	return &LifeLootTableQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeLootTable},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeLootTable entity by its id.
func (c *LifeLootTableClient) Get(ctx context.Context, id int64) (*LifeLootTable, error) {
	return c.Query().Where(lifeloottable.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeLootTableClient) GetX(ctx context.Context, id int64) *LifeLootTable {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeLootTableClient) Hooks() []Hook {
	return c.hooks.LifeLootTable
}

// Interceptors returns the client interceptors.
func (c *LifeLootTableClient) Interceptors() []Interceptor {
	return c.inters.LifeLootTable
}

func (c *LifeLootTableClient) mutate(ctx context.Context, m *LifeLootTableMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeLootTableCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeLootTableUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeLootTableUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeLootTableDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeLootTable mutation op: %q", m.Op())
	}
}

// LifePlanNodeClient is a client for the LifePlanNode schema.
type LifePlanNodeClient struct {
	config
}

// NewLifePlanNodeClient returns a client for the LifePlanNode from the given config.
func NewLifePlanNodeClient(c config) *LifePlanNodeClient {
	return &LifePlanNodeClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeplannode.Hooks(f(g(h())))`.
func (c *LifePlanNodeClient) Use(hooks ...Hook) {
	c.hooks.LifePlanNode = append(c.hooks.LifePlanNode, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeplannode.Intercept(f(g(h())))`.
func (c *LifePlanNodeClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifePlanNode = append(c.inters.LifePlanNode, interceptors...)
}

// Create returns a builder for creating a LifePlanNode entity.
func (c *LifePlanNodeClient) Create() *LifePlanNodeCreate {
	mutation := newLifePlanNodeMutation(c.config, OpCreate)
	return &LifePlanNodeCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifePlanNode entities.
func (c *LifePlanNodeClient) CreateBulk(builders ...*LifePlanNodeCreate) *LifePlanNodeCreateBulk {
	return &LifePlanNodeCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifePlanNodeClient) MapCreateBulk(slice any, setFunc func(*LifePlanNodeCreate, int)) *LifePlanNodeCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifePlanNodeCreateBulk{err: fmt.Errorf("calling to LifePlanNodeClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifePlanNodeCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifePlanNode.
func (c *LifePlanNodeClient) Update() *LifePlanNodeUpdate {
	mutation := newLifePlanNodeMutation(c.config, OpUpdate)
	return &LifePlanNodeUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifePlanNodeClient) UpdateOne(_m *LifePlanNode) *LifePlanNodeUpdateOne {
	mutation := newLifePlanNodeMutation(c.config, OpUpdateOne, withLifePlanNode(_m))
	return &LifePlanNodeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifePlanNodeClient) UpdateOneID(id int64) *LifePlanNodeUpdateOne {
	mutation := newLifePlanNodeMutation(c.config, OpUpdateOne, withLifePlanNodeID(id))
	return &LifePlanNodeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifePlanNode.
func (c *LifePlanNodeClient) Delete() *LifePlanNodeDelete {
	mutation := newLifePlanNodeMutation(c.config, OpDelete)
	return &LifePlanNodeDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifePlanNodeClient) DeleteOne(_m *LifePlanNode) *LifePlanNodeDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifePlanNodeClient) DeleteOneID(id int64) *LifePlanNodeDeleteOne {
	builder := c.Delete().Where(lifeplannode.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifePlanNodeDeleteOne{builder}
}

// Query returns a query builder for LifePlanNode.
func (c *LifePlanNodeClient) Query() *LifePlanNodeQuery {
	return &LifePlanNodeQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifePlanNode},
		inters: c.Interceptors(),
	}
}

// Get returns a LifePlanNode entity by its id.
func (c *LifePlanNodeClient) Get(ctx context.Context, id int64) (*LifePlanNode, error) {
	return c.Query().Where(lifeplannode.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifePlanNodeClient) GetX(ctx context.Context, id int64) *LifePlanNode {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifePlanNodeClient) Hooks() []Hook {
	return c.hooks.LifePlanNode
}

// Interceptors returns the client interceptors.
func (c *LifePlanNodeClient) Interceptors() []Interceptor {
	return c.inters.LifePlanNode
}

func (c *LifePlanNodeClient) mutate(ctx context.Context, m *LifePlanNodeMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifePlanNodeCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifePlanNodeUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifePlanNodeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifePlanNodeDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifePlanNode mutation op: %q", m.Op())
	}
}

// LifeProfileClient is a client for the LifeProfile schema.
type LifeProfileClient struct {
	config
}

// NewLifeProfileClient returns a client for the LifeProfile from the given config.
func NewLifeProfileClient(c config) *LifeProfileClient {
	return &LifeProfileClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeprofile.Hooks(f(g(h())))`.
func (c *LifeProfileClient) Use(hooks ...Hook) {
	c.hooks.LifeProfile = append(c.hooks.LifeProfile, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeprofile.Intercept(f(g(h())))`.
func (c *LifeProfileClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeProfile = append(c.inters.LifeProfile, interceptors...)
}

// Create returns a builder for creating a LifeProfile entity.
func (c *LifeProfileClient) Create() *LifeProfileCreate {
	mutation := newLifeProfileMutation(c.config, OpCreate)
	return &LifeProfileCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeProfile entities.
func (c *LifeProfileClient) CreateBulk(builders ...*LifeProfileCreate) *LifeProfileCreateBulk {
	return &LifeProfileCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeProfileClient) MapCreateBulk(slice any, setFunc func(*LifeProfileCreate, int)) *LifeProfileCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeProfileCreateBulk{err: fmt.Errorf("calling to LifeProfileClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeProfileCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeProfile.
func (c *LifeProfileClient) Update() *LifeProfileUpdate {
	mutation := newLifeProfileMutation(c.config, OpUpdate)
	return &LifeProfileUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeProfileClient) UpdateOne(_m *LifeProfile) *LifeProfileUpdateOne {
	mutation := newLifeProfileMutation(c.config, OpUpdateOne, withLifeProfile(_m))
	return &LifeProfileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeProfileClient) UpdateOneID(id int64) *LifeProfileUpdateOne {
	mutation := newLifeProfileMutation(c.config, OpUpdateOne, withLifeProfileID(id))
	return &LifeProfileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeProfile.
func (c *LifeProfileClient) Delete() *LifeProfileDelete {
	mutation := newLifeProfileMutation(c.config, OpDelete)
	return &LifeProfileDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeProfileClient) DeleteOne(_m *LifeProfile) *LifeProfileDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeProfileClient) DeleteOneID(id int64) *LifeProfileDeleteOne {
	builder := c.Delete().Where(lifeprofile.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeProfileDeleteOne{builder}
}

// Query returns a query builder for LifeProfile.
func (c *LifeProfileClient) Query() *LifeProfileQuery {
	return &LifeProfileQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeProfile},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeProfile entity by its id.
func (c *LifeProfileClient) Get(ctx context.Context, id int64) (*LifeProfile, error) {
	return c.Query().Where(lifeprofile.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeProfileClient) GetX(ctx context.Context, id int64) *LifeProfile {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeProfileClient) Hooks() []Hook {
	return c.hooks.LifeProfile
}

// Interceptors returns the client interceptors.
func (c *LifeProfileClient) Interceptors() []Interceptor {
	return c.inters.LifeProfile
}

func (c *LifeProfileClient) mutate(ctx context.Context, m *LifeProfileMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeProfileCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeProfileUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeProfileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeProfileDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeProfile mutation op: %q", m.Op())
	}
}

// LifeQuestClient is a client for the LifeQuest schema.
type LifeQuestClient struct {
	config
}

// NewLifeQuestClient returns a client for the LifeQuest from the given config.
func NewLifeQuestClient(c config) *LifeQuestClient {
	return &LifeQuestClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifequest.Hooks(f(g(h())))`.
func (c *LifeQuestClient) Use(hooks ...Hook) {
	c.hooks.LifeQuest = append(c.hooks.LifeQuest, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifequest.Intercept(f(g(h())))`.
func (c *LifeQuestClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeQuest = append(c.inters.LifeQuest, interceptors...)
}

// Create returns a builder for creating a LifeQuest entity.
func (c *LifeQuestClient) Create() *LifeQuestCreate {
	mutation := newLifeQuestMutation(c.config, OpCreate)
	return &LifeQuestCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeQuest entities.
func (c *LifeQuestClient) CreateBulk(builders ...*LifeQuestCreate) *LifeQuestCreateBulk {
	return &LifeQuestCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeQuestClient) MapCreateBulk(slice any, setFunc func(*LifeQuestCreate, int)) *LifeQuestCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeQuestCreateBulk{err: fmt.Errorf("calling to LifeQuestClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeQuestCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeQuest.
func (c *LifeQuestClient) Update() *LifeQuestUpdate {
	mutation := newLifeQuestMutation(c.config, OpUpdate)
	return &LifeQuestUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeQuestClient) UpdateOne(_m *LifeQuest) *LifeQuestUpdateOne {
	mutation := newLifeQuestMutation(c.config, OpUpdateOne, withLifeQuest(_m))
	return &LifeQuestUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeQuestClient) UpdateOneID(id int64) *LifeQuestUpdateOne {
	mutation := newLifeQuestMutation(c.config, OpUpdateOne, withLifeQuestID(id))
	return &LifeQuestUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeQuest.
func (c *LifeQuestClient) Delete() *LifeQuestDelete {
	mutation := newLifeQuestMutation(c.config, OpDelete)
	return &LifeQuestDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeQuestClient) DeleteOne(_m *LifeQuest) *LifeQuestDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeQuestClient) DeleteOneID(id int64) *LifeQuestDeleteOne {
	builder := c.Delete().Where(lifequest.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeQuestDeleteOne{builder}
}

// Query returns a query builder for LifeQuest.
func (c *LifeQuestClient) Query() *LifeQuestQuery {
	return &LifeQuestQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeQuest},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeQuest entity by its id.
func (c *LifeQuestClient) Get(ctx context.Context, id int64) (*LifeQuest, error) {
	return c.Query().Where(lifequest.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeQuestClient) GetX(ctx context.Context, id int64) *LifeQuest {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeQuestClient) Hooks() []Hook {
	return c.hooks.LifeQuest
}

// Interceptors returns the client interceptors.
func (c *LifeQuestClient) Interceptors() []Interceptor {
	return c.inters.LifeQuest
}

func (c *LifeQuestClient) mutate(ctx context.Context, m *LifeQuestMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeQuestCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeQuestUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeQuestUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeQuestDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeQuest mutation op: %q", m.Op())
	}
}

// LifeRewardClient is a client for the LifeReward schema.
type LifeRewardClient struct {
	config
}

// NewLifeRewardClient returns a client for the LifeReward from the given config.
func NewLifeRewardClient(c config) *LifeRewardClient {
	return &LifeRewardClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifereward.Hooks(f(g(h())))`.
func (c *LifeRewardClient) Use(hooks ...Hook) {
	c.hooks.LifeReward = append(c.hooks.LifeReward, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifereward.Intercept(f(g(h())))`.
func (c *LifeRewardClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeReward = append(c.inters.LifeReward, interceptors...)
}

// Create returns a builder for creating a LifeReward entity.
func (c *LifeRewardClient) Create() *LifeRewardCreate {
	mutation := newLifeRewardMutation(c.config, OpCreate)
	return &LifeRewardCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeReward entities.
func (c *LifeRewardClient) CreateBulk(builders ...*LifeRewardCreate) *LifeRewardCreateBulk {
	return &LifeRewardCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeRewardClient) MapCreateBulk(slice any, setFunc func(*LifeRewardCreate, int)) *LifeRewardCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeRewardCreateBulk{err: fmt.Errorf("calling to LifeRewardClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeRewardCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeReward.
func (c *LifeRewardClient) Update() *LifeRewardUpdate {
	mutation := newLifeRewardMutation(c.config, OpUpdate)
	return &LifeRewardUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeRewardClient) UpdateOne(_m *LifeReward) *LifeRewardUpdateOne {
	mutation := newLifeRewardMutation(c.config, OpUpdateOne, withLifeReward(_m))
	return &LifeRewardUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeRewardClient) UpdateOneID(id int64) *LifeRewardUpdateOne {
	mutation := newLifeRewardMutation(c.config, OpUpdateOne, withLifeRewardID(id))
	return &LifeRewardUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeReward.
func (c *LifeRewardClient) Delete() *LifeRewardDelete {
	mutation := newLifeRewardMutation(c.config, OpDelete)
	return &LifeRewardDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeRewardClient) DeleteOne(_m *LifeReward) *LifeRewardDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeRewardClient) DeleteOneID(id int64) *LifeRewardDeleteOne {
	builder := c.Delete().Where(lifereward.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeRewardDeleteOne{builder}
}

// Query returns a query builder for LifeReward.
func (c *LifeRewardClient) Query() *LifeRewardQuery {
	return &LifeRewardQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeReward},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeReward entity by its id.
func (c *LifeRewardClient) Get(ctx context.Context, id int64) (*LifeReward, error) {
	return c.Query().Where(lifereward.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeRewardClient) GetX(ctx context.Context, id int64) *LifeReward {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeRewardClient) Hooks() []Hook {
	return c.hooks.LifeReward
}

// Interceptors returns the client interceptors.
func (c *LifeRewardClient) Interceptors() []Interceptor {
	return c.inters.LifeReward
}

func (c *LifeRewardClient) mutate(ctx context.Context, m *LifeRewardMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeRewardCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeRewardUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeRewardUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeRewardDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeReward mutation op: %q", m.Op())
	}
}

// LifeRewardRedemptionClient is a client for the LifeRewardRedemption schema.
type LifeRewardRedemptionClient struct {
	config
}

// NewLifeRewardRedemptionClient returns a client for the LifeRewardRedemption from the given config.
func NewLifeRewardRedemptionClient(c config) *LifeRewardRedemptionClient {
	return &LifeRewardRedemptionClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `liferewardredemption.Hooks(f(g(h())))`.
func (c *LifeRewardRedemptionClient) Use(hooks ...Hook) {
	c.hooks.LifeRewardRedemption = append(c.hooks.LifeRewardRedemption, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `liferewardredemption.Intercept(f(g(h())))`.
func (c *LifeRewardRedemptionClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeRewardRedemption = append(c.inters.LifeRewardRedemption, interceptors...)
}

// Create returns a builder for creating a LifeRewardRedemption entity.
func (c *LifeRewardRedemptionClient) Create() *LifeRewardRedemptionCreate {
	mutation := newLifeRewardRedemptionMutation(c.config, OpCreate)
	return &LifeRewardRedemptionCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeRewardRedemption entities.
func (c *LifeRewardRedemptionClient) CreateBulk(builders ...*LifeRewardRedemptionCreate) *LifeRewardRedemptionCreateBulk {
	return &LifeRewardRedemptionCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeRewardRedemptionClient) MapCreateBulk(slice any, setFunc func(*LifeRewardRedemptionCreate, int)) *LifeRewardRedemptionCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeRewardRedemptionCreateBulk{err: fmt.Errorf("calling to LifeRewardRedemptionClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeRewardRedemptionCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeRewardRedemption.
func (c *LifeRewardRedemptionClient) Update() *LifeRewardRedemptionUpdate {
	mutation := newLifeRewardRedemptionMutation(c.config, OpUpdate)
	return &LifeRewardRedemptionUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeRewardRedemptionClient) UpdateOne(_m *LifeRewardRedemption) *LifeRewardRedemptionUpdateOne {
	mutation := newLifeRewardRedemptionMutation(c.config, OpUpdateOne, withLifeRewardRedemption(_m))
	return &LifeRewardRedemptionUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeRewardRedemptionClient) UpdateOneID(id int64) *LifeRewardRedemptionUpdateOne {
	mutation := newLifeRewardRedemptionMutation(c.config, OpUpdateOne, withLifeRewardRedemptionID(id))
	return &LifeRewardRedemptionUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeRewardRedemption.
func (c *LifeRewardRedemptionClient) Delete() *LifeRewardRedemptionDelete {
	mutation := newLifeRewardRedemptionMutation(c.config, OpDelete)
	return &LifeRewardRedemptionDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeRewardRedemptionClient) DeleteOne(_m *LifeRewardRedemption) *LifeRewardRedemptionDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeRewardRedemptionClient) DeleteOneID(id int64) *LifeRewardRedemptionDeleteOne {
	builder := c.Delete().Where(liferewardredemption.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeRewardRedemptionDeleteOne{builder}
}

// Query returns a query builder for LifeRewardRedemption.
func (c *LifeRewardRedemptionClient) Query() *LifeRewardRedemptionQuery {
	return &LifeRewardRedemptionQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeRewardRedemption},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeRewardRedemption entity by its id.
func (c *LifeRewardRedemptionClient) Get(ctx context.Context, id int64) (*LifeRewardRedemption, error) {
	return c.Query().Where(liferewardredemption.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeRewardRedemptionClient) GetX(ctx context.Context, id int64) *LifeRewardRedemption {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeRewardRedemptionClient) Hooks() []Hook {
	return c.hooks.LifeRewardRedemption
}

// Interceptors returns the client interceptors.
func (c *LifeRewardRedemptionClient) Interceptors() []Interceptor {
	return c.inters.LifeRewardRedemption
}

func (c *LifeRewardRedemptionClient) mutate(ctx context.Context, m *LifeRewardRedemptionMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeRewardRedemptionCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeRewardRedemptionUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeRewardRedemptionUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeRewardRedemptionDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeRewardRedemption mutation op: %q", m.Op())
	}
}

// LifeSkillClient is a client for the LifeSkill schema.
type LifeSkillClient struct {
	config
}

// NewLifeSkillClient returns a client for the LifeSkill from the given config.
func NewLifeSkillClient(c config) *LifeSkillClient {
	return &LifeSkillClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `lifeskill.Hooks(f(g(h())))`.
func (c *LifeSkillClient) Use(hooks ...Hook) {
	c.hooks.LifeSkill = append(c.hooks.LifeSkill, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `lifeskill.Intercept(f(g(h())))`.
func (c *LifeSkillClient) Intercept(interceptors ...Interceptor) {
	c.inters.LifeSkill = append(c.inters.LifeSkill, interceptors...)
}

// Create returns a builder for creating a LifeSkill entity.
func (c *LifeSkillClient) Create() *LifeSkillCreate {
	mutation := newLifeSkillMutation(c.config, OpCreate)
	return &LifeSkillCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LifeSkill entities.
func (c *LifeSkillClient) CreateBulk(builders ...*LifeSkillCreate) *LifeSkillCreateBulk {
	return &LifeSkillCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *LifeSkillClient) MapCreateBulk(slice any, setFunc func(*LifeSkillCreate, int)) *LifeSkillCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &LifeSkillCreateBulk{err: fmt.Errorf("calling to LifeSkillClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*LifeSkillCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for LifeSkill.
func (c *LifeSkillClient) Update() *LifeSkillUpdate {
	mutation := newLifeSkillMutation(c.config, OpUpdate)
	return &LifeSkillUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LifeSkillClient) UpdateOne(_m *LifeSkill) *LifeSkillUpdateOne {
	mutation := newLifeSkillMutation(c.config, OpUpdateOne, withLifeSkill(_m))
	return &LifeSkillUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LifeSkillClient) UpdateOneID(id int64) *LifeSkillUpdateOne {
	mutation := newLifeSkillMutation(c.config, OpUpdateOne, withLifeSkillID(id))
	return &LifeSkillUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LifeSkill.
func (c *LifeSkillClient) Delete() *LifeSkillDelete {
	mutation := newLifeSkillMutation(c.config, OpDelete)
	return &LifeSkillDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LifeSkillClient) DeleteOne(_m *LifeSkill) *LifeSkillDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LifeSkillClient) DeleteOneID(id int64) *LifeSkillDeleteOne {
	builder := c.Delete().Where(lifeskill.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LifeSkillDeleteOne{builder}
}

// Query returns a query builder for LifeSkill.
func (c *LifeSkillClient) Query() *LifeSkillQuery {
	return &LifeSkillQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLifeSkill},
		inters: c.Interceptors(),
	}
}

// Get returns a LifeSkill entity by its id.
func (c *LifeSkillClient) Get(ctx context.Context, id int64) (*LifeSkill, error) {
	return c.Query().Where(lifeskill.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LifeSkillClient) GetX(ctx context.Context, id int64) *LifeSkill {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LifeSkillClient) Hooks() []Hook {
	return c.hooks.LifeSkill
}

// Interceptors returns the client interceptors.
func (c *LifeSkillClient) Interceptors() []Interceptor {
	return c.inters.LifeSkill
}

func (c *LifeSkillClient) mutate(ctx context.Context, m *LifeSkillMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LifeSkillCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LifeSkillUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LifeSkillUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LifeSkillDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("gen: unknown LifeSkill mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *WorkflowClient) UpdateOneID(id int64) *WorkflowUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *WorkflowClient) DeleteOneID(id int64) *WorkflowDeleteOne {
...
func (c *WorkflowClient) Get(ctx context.Context, id int64) (*Workflow, error) {
	return c.Query().Where(workflow.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *WorkflowClient) GetX(ctx context.Context, id int64) *Workflow {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *WorkflowTaskClient) UpdateOneID(id int64) *WorkflowTaskUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *WorkflowTaskClient) DeleteOneID(id int64) *WorkflowTaskDeleteOne {
...
func (c *WorkflowTaskClient) Get(ctx context.Context, id int64) (*WorkflowTask, error) {
	return c.Query().Where(workflowtask.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *WorkflowTaskClient) GetX(ctx context.Context, id int64) *WorkflowTask {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *WorkflowTaskClient) mutate(ctx context.Context, m *WorkflowTaskMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown WorkflowTask mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *WorkflowTriggerClient) UpdateOneID(id int64) *WorkflowTriggerUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *WorkflowTriggerClient) DeleteOneID(id int64) *WorkflowTriggerDeleteOne {
...
func (c *WorkflowTriggerClient) Get(ctx context.Context, id int64) (*WorkflowTrigger, error) {
	return c.Query().Where(workflowtrigger.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *WorkflowTriggerClient) GetX(ctx context.Context, id int64) *WorkflowTrigger {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *WorkflowTriggerClient) mutate(ctx context.Context, m *WorkflowTriggerMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown WorkflowTrigger mutation op: %q", m.Op())
	}
}
