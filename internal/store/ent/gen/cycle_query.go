...
func (_q *CycleQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *CycleQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *CycleQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *CycleQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *CycleQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *CycleQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CycleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(cycle.Table, cycle.Columns, sqlgraph.NewFieldSpec(cycle.FieldID, field.TypeInt64))
	_spec.From = _q.sql
