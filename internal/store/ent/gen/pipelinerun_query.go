...
func (_q *PipelineRunQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PipelineRunQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *PipelineRunQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PipelineRunQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *PipelineRunQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *PipelineRunQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PipelineRunQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(pipelinerun.Table, pipelinerun.Columns, sqlgraph.NewFieldSpec(pipelinerun.FieldID, field.TypeInt64))
	_spec.From = _q.sql
