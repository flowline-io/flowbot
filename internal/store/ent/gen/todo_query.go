...
func (_q *TodoQuery) QueryKeyResult() *KeyResultQuery {
...
// QuerySubTodos chains the current query on the "sub_todos" edge.
func (_q *TodoQuery) QuerySubTodos() *TodoQuery {
	query := (&TodoClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *TodoQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *TodoQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *TodoQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *TodoQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *TodoQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *TodoQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TodoQuery) Clone() *TodoQuery {
	...
	return &TodoQuery{
		...
		withSubTodos:  _q.withSubTodos.Clone(),
...
func (_q *TodoQuery) WithKeyResult(opts ...func(*KeyResultQuery)) *TodoQuery {
	query := (&KeyResultClient{config: _q.config}).Query()
...
// WithSubTodos tells the query-builder to eager-load the nodes that are connected to
// the "sub_todos" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *TodoQuery) WithSubTodos(opts ...func(*TodoQuery)) *TodoQuery {
	query := (&TodoClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withSubTodos = query
	return _q
}
...
func (_q *TodoQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Todo, error) {
	...
	if query := _q.withKeyResult; query != nil {
		if err := _q.loadKeyResult(ctx, query, nodes, nil,
			func(n *Todo, e *KeyResult) { n.Edges.KeyResult = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withSubTodos; query != nil {
		if err := _q.loadSubTodos(ctx, query, nodes,
			func(n *Todo) { n.Edges.SubTodos = []*Todo{} },
			func(n *Todo, e *Todo) { n.Edges.SubTodos = append(n.Edges.SubTodos, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TodoQuery) loadKeyResult(ctx context.Context, query *KeyResultQuery, nodes []*Todo, init func(*Todo), assign func(*Todo, *KeyResult)) error {
...
func (_q *TodoQuery) loadSubTodos(ctx context.Context, query *TodoQuery, nodes []*Todo, init func(*Todo), assign func(*Todo, *Todo)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(todo.FieldParentID)
	}
	query.Where(predicate.Todo(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(todo.SubTodosColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TodoQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withKeyResult != nil {
			_spec.Node.AddColumnOnce(todo.FieldKeyResultID)
		}
		if _q.withParent != nil {
			_spec.Node.AddColumnOnce(todo.FieldParentID)
		}
	}
