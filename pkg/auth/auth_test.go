...
func TestHasMinimumServiceScope(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "pipeline read for pipeline GET", scopes: []string{ScopePipelineRead}, group: "pipeline", method: "GET", want: true},
		{name: "pipeline run satisfies pipeline GET", scopes: []string{ScopePipelineRun}, group: "pipeline", method: "GET", want: true},
		{name: "pipeline read denies pipeline POST", scopes: []string{ScopePipelineRead}, group: "pipeline", method: "POST", want: false},
		{name: "function read for functions GET", scopes: []string{ScopeFunctionRead}, group: "functions", method: "GET", want: true},
		{name: "function run satisfies functions GET", scopes: []string{ScopeFunctionRun}, group: "functions", method: "GET", want: true},
		{name: "function read denies functions POST", scopes: []string{ScopeFunctionRead}, group: "functions", method: "POST", want: false},
...
func TestMinimumServiceScope(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "pipeline GET", group: "pipeline", method: "GET", want: ScopePipelineRead},
		{name: "pipeline POST", group: "pipeline", method: "POST", want: ScopePipelineRun},
		{name: "functions GET", group: "functions", method: "GET", want: ScopeFunctionRead},
		{name: "functions POST", group: "functions", method: "POST", want: ScopeFunctionRun},
