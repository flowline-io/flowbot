...
func RunExampleConformance(t *testing.T, factory ExampleServiceFactory) {
	t.Run("get item success", func(t *testing.T) {
		svc := factory(t, ExampleConfig{
			GetItem: &capability.Host{Name: "test-item", Status: "ok"},
		})
	...
	t.Run("list items success", func(t *testing.T) {
		...
		result, err := svc.ListItems(t.Context(), &capability.ExampleListQuery{Page: capability.PageRequest{Limit: 20}})
		require.NoError(t, err)
	...
	t.Run("list items empty", func(t *testing.T) {
		svc := factory(t, ExampleConfig{})
		result, err := svc.ListItems(t.Context(), &capability.ExampleListQuery{})
		require.NoError(t, err)
		require.NotNil(t, result)
		require.NotNil(t, result.Items)
	...
	t.Run("list items provider error", func(t *testing.T) {
		...
		_, err := svc.ListItems(t.Context(), &capability.ExampleListQuery{})
		RequireProviderError(t, err)
	})

	t.Run("create item success", func(t *testing.T) {
		svc := factory(t, ExampleConfig{
			CreateItem: &capability.Host{Name: "new-item", Status: "ok"},
		})
	...
	t.Run("update item success", func(t *testing.T) {
		svc := factory(t, ExampleConfig{
			UpdateItem: &capability.Host{Name: "updated-item", Status: "active"},
		})
