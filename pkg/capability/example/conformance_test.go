...
func (w *conformanceWrapper) ListItems(ctx context.Context, _ *ListQuery) (*capability.ListResult[capability.Host], error) {
	...
	if w.cfg.ListItems != nil {
		return &capability.ListResult[capability.Host]{Items: w.cfg.ListItems}, nil
	}
	return &capability.ListResult[capability.Host]{Items: []*capability.Host{}, Page: &capability.PageInfo{}}, nil
}
...
func TestExampleConformance(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			conformance.RunExampleConformance(t, func(_ *testing.T, cfg conformance.ExampleConfig) conformance.ExampleService {
