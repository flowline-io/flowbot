...
func (*fakeNotePollerService) List(_ context.Context, _ *ListQuery) (*capability.ListResult[capability.Note], error) {
	return nil, nil
}
func (*fakeNotePollerService) Get(_ context.Context, _ string) (*capability.Note, error) {
	return nil, nil
}
