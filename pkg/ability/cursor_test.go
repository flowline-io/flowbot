...
func TestCursorRoundTrip(t *testing.T) {
	...
	tests := []struct {
		...
		{"encode and decode cursor returns original payload", "bookmark", "karakeep", "page", 2, 20, 0, "", ""},
		{"round trip with offset-based strategy preserves offset", "reader", "miniflux", "offset", 0, 30, 50, "id", "asc"},
		{"round trip with sort fields preserves sort info", "kanban", "kanboard", "page", 1, 10, 0, "created_at", "desc"},
	}
