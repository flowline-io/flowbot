...
func toForgeUser(user *giteasdk.User) *ability.ForgeUser {
	if user == nil {
		return nil
	}
...
func toForgeRepo(repo *giteasdk.Repository) *ability.ForgeRepo {
	if repo == nil {
		return nil
	}
	ownerName := ""
...
func toForgeIssue(issue *giteasdk.Issue) *ability.ForgeIssue {
	if issue == nil {
		return nil
	}
	author := ""
