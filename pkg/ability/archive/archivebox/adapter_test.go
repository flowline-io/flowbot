...
func TestAddCreatesArchiveItem(t *testing.T) {
	...
	item, err := adapter.Add(context.Background(), archive.AddRequest{URL: "https://example.com"})
...
func TestAddWrapsProviderError(t *testing.T) {
	...
	_, err := adapter.Add(context.Background(), archive.AddRequest{URL: "https://example.com"})
	require.Error(t, err)
...
func TestAddRejectsEmptyURL(t *testing.T) {
	...
	_, err := adapter.Add(context.Background(), archive.AddRequest{})
	require.Error(t, err)
