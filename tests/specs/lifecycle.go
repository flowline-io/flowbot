...
var _ = SynchronizedBeforeSuite(
	...
	func(data []byte) {
		...
		// module data, and notify helpers resolve after the store decoupling.
		server.WireAccessTokenStore()
		server.WireModuleDataStore()
		server.WireNotifyStores()
		server.WireMessageDestinations()
		server.WireOAuthTokenStore()
		server.WireFileMetaStore()
